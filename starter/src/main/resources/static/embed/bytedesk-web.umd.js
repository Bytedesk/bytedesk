(function(m,r){typeof exports=="object"&&typeof module<"u"?module.exports=r():typeof define=="function"&&define.amd?define(r):(m=typeof globalThis<"u"?globalThis:m||self,m.BytedeskWeb=r())})(this,function(){"use strict";var H=Object.defineProperty;var _=(m,r,t)=>r in m?H(m,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[r]=t;var g=(m,r,t)=>_(m,typeof r!="symbol"?r+"":r,t);class m{constructor(t){g(this,"config");g(this,"bubble",null);g(this,"window",null);g(this,"inviteDialog",null);g(this,"contextMenu",null);g(this,"hideTimeout",null);g(this,"isVisible",!1);g(this,"isDragging",!1);g(this,"windowState","normal");g(this,"loopCount",0);g(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var p,x,w,l,a,y,I,$,D,S,L,z,B;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((p=this.config.bubbleConfig)!=null&&p.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const s=document.createElement("div");s.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const v=document.createElement("span");v.textContent=((l=this.config.bubbleConfig)==null?void 0:l.icon)||"",v.style.fontSize="20px",s.appendChild(v);const E=document.createElement("div"),C=document.createElement("div");C.textContent=((a=this.config.bubbleConfig)==null?void 0:a.title)||"",C.style.fontWeight="bold",C.style.color=((y=this.config.theme)==null?void 0:y.mode)==="dark"?"#e5e7eb":"#1f2937",C.style.marginBottom="4px",E.appendChild(C);const f=document.createElement("div");f.textContent=((I=this.config.bubbleConfig)==null?void 0:I.subtitle)||"",f.style.fontSize="0.9em",f.style.color=(($=this.config.theme)==null?void 0:$.mode)==="dark"?"#9ca3af":"#4b5563",E.appendChild(f),s.appendChild(E),e.appendChild(s);const T=document.createElement("div");T.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `,e.appendChild(T),e.appendChild(M),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button");const i=this.config.buttonConfig||{},n=i.width||60,o=i.height||60,h=Math.min(n,o)/2,d=((L=this.config.theme)==null?void 0:L.mode)==="dark",u=d?"#3B82F6":"#0066FF",b=((z=this.config.theme)==null?void 0:z.backgroundColor)||u;this.bubble.style.cssText=`
      background-color: ${b};
      width: ${n}px;
      height: ${o}px;
      border-radius: ${h}px;
    ...
    `,i.icon){const s=document.createElement("span");s.textContent=i.icon,s.style.fontSize=`${o*.4}px`,c.appendChild(s)}else{const s=document.createElement("div");s.innerHTML=`
      ...
      `,c.appendChild(s)}if(i.text){const s=document.createElement("span");s.textContent=i.text,s.style.cssText=`
        ...
        font-size: ${o*.25}px;
        white-space: nowrap;
      `,c.appendChild(s)}if(this.bubble.appendChild(c),this.bubble.addEventListener("mouseenter",()=>{this.bubble.style.transform="scale(1.1)"}),this.bubble.addEventListener("mouseleave",()=>{this.bubble.style.transform="scale(1)"}),t.appendChild(this.bubble),this.config.draggable){let s=0,v=0,E=0,C=0;this.bubble.addEventListener("mousedown",f=>{f.button===0&&(this.isDragging=!0,s=f.clientX,v=f.clientY,E=t.offsetLeft,C=t.offsetTop,t.style.transition="none")}),document.addEventListener("mousemove",f=>{if(!this.isDragging)return;f.preventDefault();const T=f.clientX-s,M=f.clientY-v,k=E+T,W=C+M,R=window.innerHeight-t.offsetHeight;k<=window.innerWidth/2?(t.style.left=`${Math.max(0,k)}px`,t.style.right="auto",this.config.placement="bottom-left"):(t.style.right=`${Math.max(0,window.innerWidth-k-t.offsetWidth)}px`,t.style.left="auto",this.config.placement="bottom-right"),t.style.bottom=`${Math.min(Math.max(0,window.innerHeight-W-t.offsetHeight),R)}px`}),document.addEventListener("mouseup",()=>{this.isDragging&&(this.isDragging=!1,t.style.transition="all 0.3s ease",this.config.marginSide=parseInt(this.config.placement==="bottom-left"?t.style.left:t.style.right)||20,this.config.marginBottom=parseInt(t.style.bottom||"20"))})}this.bubble.addEventListener("click",()=>{if(!this.isDragging){console.log("bubble click");const s=this.bubble.messageElement;s instanceof HTMLElement&&(s.style.display="none"),this.showChat()}}),this.bubble.messageElement=e,document.body.appendChild(t),this.bubble.addEventListener("contextmenu",s=>{this.showContextMenu(s)}),document.addEventListener("click",()=>{this.hideContextMenu()})}getSupportText(){var i;const t=((i=this.config)==null?void 0:i.locale)||"zh-cn",e={"zh-cn":"微语技术支持","zh-tw":"微語技術支援",en:"Powered by Bytedesk",ja:"Bytedeskによる技術支援",ko:"Bytedesk 기술 지원"};return e[t]||e["zh-cn"]}createChatWindow(){var d,u,b,c,p,x,w;this.window=document.createElement("div");const t=window.innerWidth<=768,e=window.innerWidth,i=window.innerHeight,n=Math.min(((d=this.config.window)==null?void 0:d.width)||e*.9,e*.9),o=Math.min(((u=this.config.window)==null?void 0:u.height)||i*.9,i*.9);t?this.window.style.cssText=`
        position: fixed;
        left: 0;
        bottom: 0;
        width: 100%;
        ...
        overflow: hidden;
        transition: all ${(b=this.config.animation)==null?void 0:b.duration}ms ${(c=this.config.animation)==null?void 0:c.type};
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(p=this.config.animation)==null?void 0:p.duration}ms ${(x=this.config.animation)==null?void 0:x.type};
    ...
    `,h.src=this.generateChatUrl(),console.log("iframe.src: ",h.src),this.window.appendChild(h),this.config.showSupport){const l=document.createElement("div"),a=((w=this.config.theme)==null?void 0:w.mode)==="dark";l.style.cssText=`
        height: 24px;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    `,e.textContent=this.config.inviteConfig.text||"需要帮助吗？点击开始对话",this.inviteDialog.appendChild(e);const i=document.createElement("div");i.style.cssText=`
      ...
      gap: 10px;
      justify-content: center;
    `;const n=document.createElement("button");n.textContent=((c=(b=this.config)==null?void 0:b.inviteConfig)==null?void 0:c.acceptText)||"开始对话";const o=((p=this.config.theme)==null?void 0:p.backgroundColor)||(t?"#3B82F6":"#0066FF");n.style.cssText=`
      padding: 8px 16px;
      background: ${o};
      color: white;
      border: none;
      border-radius: 4px;
      cursor: pointer;
    `,n.onclick=()=>{var l,a,y;this.hideInviteDialog(),this.showChat(),(y=(a=(l=this.config)==null?void 0:l.inviteConfig)==null?void 0:a.onAccept)==null||y.call(a)};const h=document.createElement("button");h.textContent=((w=(x=this.config)==null?void 0:x.inviteConfig)==null?void 0:w.rejectText)||"稍后再说",h.style.cssText=`
      padding: 8px 16px;
