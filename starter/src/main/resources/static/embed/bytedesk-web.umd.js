(function(h,l){typeof exports=="object"&&typeof module<"u"?module.exports=l():typeof define=="function"&&define.amd?define(l):(h=typeof globalThis<"u"?globalThis:h||self,h.BytedeskWeb=l())})(this,function(){"use strict";var E=Object.defineProperty;var C=(h,l,t)=>l in h?E(h,l,{enumerable:!0,configurable:!0,writable:!0,value:t}):h[l]=t;var f=(h,l,t)=>C(h,typeof l!="symbol"?l+"":l,t);class h{constructor(t){f(this,"config");f(this,"bubble",null);f(this,"window",null);f(this,"isVisible",!1);f(this,"isDragging",!1);f(this,"windowState","normal");this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{baseUrl:"https://www.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},showSupport:!0,chatParams:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){this.createBubble(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3)}createBubble(){var o,a,c,g,p;const t=document.createElement("div");t.style.cssText=`
      position: fixed;
    ...
    `;let e=null;if((o=this.config.bubbleConfig)!=null&&o.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const s=document.createElement("div");s.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const d=document.createElement("span");d.textContent=((a=this.config.bubbleConfig)==null?void 0:a.icon)||"",d.style.fontSize="20px",s.appendChild(d);const r=document.createElement("div"),m=document.createElement("div");m.textContent=((c=this.config.bubbleConfig)==null?void 0:c.title)||"",m.style.fontWeight="bold",m.style.marginBottom="4px",r.appendChild(m);const n=document.createElement("div");n.textContent=((g=this.config.bubbleConfig)==null?void 0:g.subtitle)||"",n.style.fontSize="0.9em",n.style.opacity="0.8",r.appendChild(n),s.appendChild(r),e.appendChild(s);const b=document.createElement("div");b.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `;const w=document.createElement("div");w.style.cssText=`
        ...
        height: 12px;
        background: white;
      `,e.appendChild(b),e.appendChild(w),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button"),this.bubble.style.cssText=`
    ...
    `,this.bubble.appendChild(i),this.bubble.addEventListener("mouseenter",()=>{this.bubble.style.transform="scale(1.1)"}),this.bubble.addEventListener("mouseleave",()=>{this.bubble.style.transform="scale(1)"}),t.appendChild(this.bubble),this.config.draggable){let s=0,d=0,r=0,m=0;this.bubble.addEventListener("mousedown",n=>{n.button===0&&(this.isDragging=!0,s=n.clientX,d=n.clientY,r=t.offsetLeft,m=t.offsetTop,t.style.transition="none")}),document.addEventListener("mousemove",n=>{if(!this.isDragging)return;n.preventDefault();const b=n.clientX-s,w=n.clientY-d,u=r+b,x=m+w,y=window.innerHeight-t.offsetHeight;u<=window.innerWidth/2?(t.style.left=`${Math.max(0,u)}px`,t.style.right="auto",this.config.placement="bottom-left"):(t.style.right=`${Math.max(0,window.innerWidth-u-t.offsetWidth)}px`,t.style.left="auto",this.config.placement="bottom-right"),t.style.bottom=`${Math.min(Math.max(0,window.innerHeight-x-t.offsetHeight),y)}px`}),document.addEventListener("mouseup",()=>{this.isDragging&&(this.isDragging=!1,t.style.transition="all 0.3s ease",this.config.marginSide=parseInt(this.config.placement==="bottom-left"?t.style.left:t.style.right)||20,this.config.marginBottom=parseInt(t.style.bottom||"20"))})}this.bubble.addEventListener("click",()=>{if(!this.isDragging){console.log("bubble click");const s=this.bubble.messageElement;s instanceof HTMLElement&&(s.style.display="none"),this.showChat()}}),this.bubble.messageElement=e,document.body.appendChild(t)}getSupportText(){const t=this.config.locale||"zh-cn",e={"zh-cn":"微语技术支持",en:"Powered by Weiyuai","ja-JP":"Weiyuaiによる技術支援","ko-KR":"Weiyuai 기술 지원"};return e[t]||e["zh-cn"]}createChatWindow(){var g,p,s,d,r,m;this.window=document.createElement("div");const t=window.innerWidth<=768,e=window.innerWidth,i=window.innerHeight,o=Math.min(((g=this.config.window)==null?void 0:g.width)||e*.9,e*.9),a=Math.min(((p=this.config.window)==null?void 0:p.height)||i*.9,i*.9);t?this.window.style.cssText=`
        ...
        overflow: hidden;
        transition: all ${(s=this.config.animation)==null?void 0:s.duration}ms ${(d=this.config.animation)==null?void 0:d.type};
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(r=this.config.animation)==null?void 0:r.duration}ms ${(m=this.config.animation)==null?void 0:m.type};
      `;const c=document.createElement("iframe");if(c.style.cssText=`
      width: 100%;
      height: ${this.config.showSupport?"calc(100% - 30px)":"100%"};
      border: none;
    `,c.src=this.generateChatUrl(),console.log("iframe.src: ",c.src),this.window.appendChild(c),this.config.showSupport){const n=document.createElement("div");n.style.cssText=`
        height: 20px;
        display: flex;
        align-items: center;
        justify-content: center;
