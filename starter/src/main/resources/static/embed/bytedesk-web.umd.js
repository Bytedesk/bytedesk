(function(m,r){typeof exports=="object"&&typeof module<"u"?module.exports=r():typeof define=="function"&&define.amd?define(r):(m=typeof globalThis<"u"?globalThis:m||self,m.BytedeskWeb=r())})(this,function(){"use strict";var H=Object.defineProperty;var _=(m,r,t)=>r in m?H(m,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[r]=t;var g=(m,r,t)=>_(m,typeof r!="symbol"?r+"":r,t);class m{constructor(t){g(this,"config");g(this,"bubble",null);g(this,"window",null);g(this,"inviteDialog",null);g(this,"contextMenu",null);g(this,"hideTimeout",null);g(this,"isVisible",!1);g(this,"isDragging",!1);g(this,"windowState","normal");g(this,"loopCount",0);g(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,forceRefresh:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var p,w,a,f,y,I,$,k,D,S,L,z,B;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((p=this.config.bubbleConfig)!=null&&p.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `,l.setAttribute("data-placement",this.config.placement||"bottom-right");const C=document.createElement("span");C.textContent=((f=this.config.bubbleConfig)==null?void 0:f.icon)||"",C.style.fontSize="20px",l.appendChild(C);const v=document.createElement("div"),x=document.createElement("div");x.textContent=((y=this.config.bubbleConfig)==null?void 0:y.title)||"",x.style.fontWeight="bold",x.style.color=((I=this.config.theme)==null?void 0:I.mode)==="dark"?"#e5e7eb":"#1f2937",x.style.marginBottom="4px",x.style.textAlign=this.config.placement==="bottom-left"?"left":"right",v.appendChild(x);const c=document.createElement("div");c.textContent=(($=this.config.bubbleConfig)==null?void 0:$.subtitle)||"",c.style.fontSize="0.9em",c.style.color=((k=this.config.theme)==null?void 0:k.mode)==="dark"?"#9ca3af":"#4b5563",c.style.textAlign=this.config.placement==="bottom-left"?"left":"right",v.appendChild(c),l.appendChild(v),e.appendChild(l);const E=document.createElement("div");E.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `,e.appendChild(E),e.appendChild(T),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button");const i=this.config.buttonConfig||{},n=i.width||60,o=i.height||60,s=Math.min(n,o)/2,h=((L=this.config.theme)==null?void 0:L.mode)==="dark",b=h?"#3B82F6":"#0066FF",u=((z=this.config.theme)==null?void 0:z.backgroundColor)||b;this.bubble.style.cssText=`
      background-color: ${u};
      width: ${n}px;
      height: ${o}px;
      border-radius: ${s}px;
    ...
    `,s.src=this.generateChatUrl(),console.log("iframe.src: ",s.src),this.window.appendChild(s),this.config.showSupport){const f=document.createElement("div"),y=((a=this.config.theme)==null?void 0:a.mode)==="dark";f.style.cssText=`
        height: 24px;
        display: flex;
        align-items: center;
        justify-content: center;
      ...
      max-width: 300px;
      text-align: center;
    `,(b=this.config.inviteConfig)!=null&&b.icon){const a=document.createElement("div");a.style.cssText=`
        font-size: 32px;
        margin-bottom: 12px;
        color: ${t?"#e5e7eb":"#333"};
    ...
    `;const n=document.createElement("button");n.textContent=((d=this.config.inviteConfig)==null?void 0:d.acceptText)||"开始对话";const o=((p=this.config.theme)==null?void 0:p.backgroundColor)||(t?"#3B82F6":"#0066FF");n.style.cssText=`
      ...
      border-radius: 4px;
      cursor: pointer;
    `,n.onclick=()=>{var a,f;this.hideInviteDialog(),this.showChat(),(f=(a=this.config.inviteConfig)==null?void 0:a.onAccept)==null||f.call(a)};const s=document.createElement("button");s.textContent=((w=this.config.inviteConfig)==null?void 0:w.rejectText)||"稍后再说",s.style.cssText=`
      padding: 8px 16px;
