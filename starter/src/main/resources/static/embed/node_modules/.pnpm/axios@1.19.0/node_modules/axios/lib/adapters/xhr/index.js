...
import { toByteStringHeaderObject as t } from "../../helpers/sanitizeHeaderValue/index.js";
import n from "../../core/AxiosHeaders/index.js";
import r from "../../core/AxiosError/index.js";
import i from "../../defaults/transitional/index.js";
import a from "../../platform/index/index.js";
import o from "../../cancel/CanceledError/index.js";
import s from "../../core/settle/index.js";
import c from "../../helpers/parseProtocol/index.js";
import { progressEventReducer as l } from "../../helpers/progressEventReducer/index.js";
import u from "../../helpers/resolveConfig/index.js";
var d = typeof XMLHttpRequest < "u" && function(d) {
	return new Promise(function(f, p) {
		...
		function D() {
			if (!E) return;
			let e = n.from("getAllResponseHeaders" in E && E.getAllResponseHeaders()), t = {
		...
		"onloadend" in E ? E.onloadend = D : E.onreadystatechange = function() {
			...
			let t = e && e.message ? e.message : "Network Error", n = new r(t, r.ERR_NETWORK, d, E);
			n.event = e || null, p(n), T(), E = null;
		...
		if (O && !a.protocols.includes(O)) {
			p(new r("Unsupported protocol " + O + ":", r.ERR_BAD_REQUEST, d)), T();
			return;
		}
		E.send(h || null);
	});
