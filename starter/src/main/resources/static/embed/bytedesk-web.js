var BytedeskWeb=function(){"use strict";var z=Object.defineProperty;var W=(x,u,t)=>u in x?z(x,u,{enumerable:!0,configurable:!0,writable:!0,value:t}):x[u]=t;var f=(x,u,t)=>W(x,typeof u!="symbol"?u+"":u,t);class x{constructor(t){f(this,"config");f(this,"bubble",null);f(this,"window",null);f(this,"inviteDialog",null);f(this,"contextMenu",null);f(this,"hideTimeout",null);f(this,"isVisible",!1);f(this,"isDragging",!1);f(this,"windowState","normal");f(this,"loopCount",0);f(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var p,m,g,l,h,c,T,M,I,k,D,$;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((p=this.config.bubbleConfig)!=null&&p.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const s=document.createElement("div");s.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const w=document.createElement("span");w.textContent=((l=this.config.bubbleConfig)==null?void 0:l.icon)||"",w.style.fontSize="20px",s.appendChild(w);const y=document.createElement("div"),b=document.createElement("div");b.textContent=((h=this.config.bubbleConfig)==null?void 0:h.title)||"",b.style.fontWeight="bold",b.style.color=((c=this.config.theme)==null?void 0:c.mode)==="dark"?"#e5e7eb":"#1f2937",b.style.marginBottom="4px",y.appendChild(b);const r=document.createElement("div");r.textContent=((T=this.config.bubbleConfig)==null?void 0:T.subtitle)||"",r.style.fontSize="0.9em",r.style.color=((M=this.config.theme)==null?void 0:M.mode)==="dark"?"#9ca3af":"#4b5563",y.appendChild(r),s.appendChild(y),e.appendChild(s);const C=document.createElement("div");C.style.cssText=`
        position: absolute;
        bottom: -6px;
    ...
    `,d.src=this.generateChatUrl(),console.log("iframe.src: ",d.src),this.window.appendChild(d),this.config.showSupport){const c=document.createElement("div");c.style.cssText=`
        height: 24px;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    `;const i=document.createElement("button");i.textContent=((a=(d=this.config)==null?void 0:d.inviteConfig)==null?void 0:a.acceptText)||"开始对话",i.style.cssText=`
      ...
      border-radius: 4px;
      cursor: pointer;
    `,i.onclick=()=>{var l,h,c;this.hideInviteDialog(),this.showChat(),(c=(h=(l=this.config)==null?void 0:l.inviteConfig)==null?void 0:h.onAccept)==null||c.call(h)};const n=document.createElement("button");n.textContent=((g=(m=this.config)==null?void 0:m.inviteConfig)==null?void 0:g.rejectText)||"稍后再说",n.style.cssText=`
      padding: 8px 16px;
      background: #f5f5f5;
      color: #666;
      border: none;
