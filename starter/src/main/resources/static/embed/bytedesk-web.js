var BytedeskWeb=function(){"use strict";var k=Object.defineProperty;var S=(f,c,t)=>c in f?k(f,c,{enumerable:!0,configurable:!0,writable:!0,value:t}):f[c]=t;var r=(f,c,t)=>S(f,typeof c!="symbol"?c+"":c,t);class f{constructor(t){r(this,"config");r(this,"bubble",null);r(this,"window",null);r(this,"inviteDialog",null);r(this,"isVisible",!1);r(this,"isDragging",!1);r(this,"windowState","normal");r(this,"loopCount",0);r(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://www.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},showSupport:!0,chatParams:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteParams)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteParams.delay||3e3)}createBubble(){var n,s,a,o,l,b,g,m,y,u,T;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((n=this.config.bubbleConfig)!=null&&n.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const d=document.createElement("div");d.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const w=document.createElement("span");w.textContent=((o=this.config.bubbleConfig)==null?void 0:o.icon)||"",w.style.fontSize="20px",d.appendChild(w);const x=document.createElement("div"),p=document.createElement("div");p.textContent=((l=this.config.bubbleConfig)==null?void 0:l.title)||"",p.style.fontWeight="bold",p.style.color=((b=this.config.theme)==null?void 0:b.mode)==="dark"?"#e5e7eb":"#1f2937",p.style.marginBottom="4px",x.appendChild(p);const h=document.createElement("div");h.textContent=((g=this.config.bubbleConfig)==null?void 0:g.subtitle)||"",h.style.fontSize="0.9em",h.style.color=((m=this.config.theme)==null?void 0:m.mode)==="dark"?"#9ca3af":"#4b5563",x.appendChild(h),d.appendChild(x),e.appendChild(d);const v=document.createElement("div");v.style.cssText=`
        position: absolute;
        bottom: -6px;
    ...
    `,this.bubble.appendChild(i),this.bubble.addEventListener("mouseenter",()=>{this.bubble.style.transform="scale(1.1)"}),this.bubble.addEventListener("mouseleave",()=>{this.bubble.style.transform="scale(1)"}),t.appendChild(this.bubble),this.config.draggable){let d=0,w=0,x=0,p=0;this.bubble.addEventListener("mousedown",h=>{h.button===0&&(this.isDragging=!0,d=h.clientX,w=h.clientY,x=t.offsetLeft,p=t.offsetTop,t.style.transition="none")}),document.addEventListener("mousemove",h=>{if(!this.isDragging)return;h.preventDefault();const v=h.clientX-d,C=h.clientY-w,E=x+v,I=p+C,D=window.innerHeight-t.offsetHeight;E<=window.innerWidth/2?(t.style.left=`${Math.max(0,E)}px`,t.style.right="auto",this.config.placement="bottom-left"):(t.style.right=`${Math.max(0,window.innerWidth-E-t.offsetWidth)}px`,t.style.left="auto",this.config.placement="bottom-right"),t.style.bottom=`${Math.min(Math.max(0,window.innerHeight-I-t.offsetHeight),D)}px`}),document.addEventListener("mouseup",()=>{this.isDragging&&(this.isDragging=!1,t.style.transition="all 0.3s ease",this.config.marginSide=parseInt(this.config.placement==="bottom-left"?t.style.left:t.style.right)||20,this.config.marginBottom=parseInt(t.style.bottom||"20"))})}this.bubble.addEventListener("click",()=>{if(!this.isDragging){console.log("bubble click");const d=this.bubble.messageElement;d instanceof HTMLElement&&(d.style.display="none"),this.showChat()}}),this.bubble.messageElement=e,document.body.appendChild(t)}getSupportText(){const t=this.config.locale||"zh-cn",e={"zh-cn":"微语技术支持",en:"Powered by Weiyuai","ja-JP":"Weiyuaiによる技術支援","ko-KR":"Weiyuai 기술 지원"};return e[t]||e["zh-cn"]}createChatWindow(){var o,l,b,g,m,y;this.window=document.createElement("div");const t=window.innerWidth<=768,e=window.innerWidth,i=window.innerHeight,n=Math.min(((o=this.config.window)==null?void 0:o.width)||e*.9,e*.9),s=Math.min(((l=this.config.window)==null?void 0:l.height)||i*.9,i*.9);t?this.window.style.cssText=`
      ...
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(m=this.config.animation)==null?void 0:m.duration}ms ${(y=this.config.animation)==null?void 0:y.type};
