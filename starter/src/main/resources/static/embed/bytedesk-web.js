var BytedeskWeb=function(){"use strict";var H=Object.defineProperty;var _=(w,u,t)=>u in w?H(w,u,{enumerable:!0,configurable:!0,writable:!0,value:t}):w[u]=t;var g=(w,u,t)=>_(w,typeof u!="symbol"?u+"":u,t);class w{constructor(t){g(this,"config");g(this,"bubble",null);g(this,"window",null);g(this,"inviteDialog",null);g(this,"contextMenu",null);g(this,"hideTimeout",null);g(this,"isVisible",!1);g(this,"isDragging",!1);g(this,"windowState","normal");g(this,"loopCount",0);g(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var f,x,l,r,y,k,$,I,D,S,L,z,B;const t=document.createElement("div");t.style.cssText=`
      ...
      gap: 10px;
      z-index: 9999;
    `;let e=null;if((f=this.config.bubbleConfig)!=null&&f.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `,s.setAttribute("data-placement",this.config.placement||"bottom-right");const C=document.createElement("span");C.textContent=((r=this.config.bubbleConfig)==null?void 0:r.icon)||"",C.style.fontSize="20px",s.appendChild(C);const v=document.createElement("div"),b=document.createElement("div");b.textContent=((y=this.config.bubbleConfig)==null?void 0:y.title)||"",b.style.fontWeight="bold",b.style.color=((k=this.config.theme)==null?void 0:k.mode)==="dark"?"#e5e7eb":"#1f2937",b.style.marginBottom="4px",b.style.textAlign=this.config.placement==="bottom-left"?"left":"right",v.appendChild(b);const c=document.createElement("div");c.textContent=(($=this.config.bubbleConfig)==null?void 0:$.subtitle)||"",c.style.fontSize="0.9em",c.style.color=((I=this.config.theme)==null?void 0:I.mode)==="dark"?"#9ca3af":"#4b5563",c.style.textAlign=this.config.placement==="bottom-left"?"left":"right",v.appendChild(c),s.appendChild(v),e.appendChild(s);const E=document.createElement("div");E.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `,e.appendChild(E),e.appendChild(T),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button");const i=this.config.buttonConfig||{},n=i.width||60,o=i.height||60,a=Math.min(n,o)/2,h=((L=this.config.theme)==null?void 0:L.mode)==="dark",m=h?"#3B82F6":"#0066FF",p=((z=this.config.theme)==null?void 0:z.backgroundColor)||m;this.bubble.style.cssText=`
      background-color: ${p};
      width: ${n}px;
      height: ${o}px;
      border-radius: ${a}px;
    ...
    `,i.icon){const s=document.createElement("span");s.textContent=i.icon,s.style.fontSize=`${o*.4}px`,d.appendChild(s)}else{const s=document.createElement("div");s.innerHTML=`
      ...
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(f=this.config.animation)==null?void 0:f.duration}ms ${(x=this.config.animation)==null?void 0:x.type};
    ...
    `,a.src=this.generateChatUrl(),console.log("iframe.src: ",a.src),this.window.appendChild(a),this.config.showSupport){const r=document.createElement("div"),y=((l=this.config.theme)==null?void 0:l.mode)==="dark";r.style.cssText=`
        height: 24px;
        display: flex;
        align-items: center;
        justify-content: center;
      ...
      max-width: 300px;
      text-align: center;
    `,(m=this.config.inviteConfig)!=null&&m.icon){const l=document.createElement("div");l.style.cssText=`
        font-size: 32px;
        margin-bottom: 12px;
        color: ${t?"#e5e7eb":"#333"};
    ...
    `,e.textContent=((p=this.config.inviteConfig)==null?void 0:p.text)||"需要帮助吗？点击开始对话",this.inviteDialog.appendChild(e);const i=document.createElement("div");i.style.cssText=`
      ...
      gap: 10px;
      justify-content: center;
    `;const n=document.createElement("button");n.textContent=((d=this.config.inviteConfig)==null?void 0:d.acceptText)||"开始对话";const o=((f=this.config.theme)==null?void 0:f.backgroundColor)||(t?"#3B82F6":"#0066FF");n.style.cssText=`
      padding: 8px 16px;
      background: ${o};
      color: white;
      border: none;
      border-radius: 4px;
      cursor: pointer;
    `,n.onclick=()=>{var l,r;this.hideInviteDialog(),this.showChat(),(r=(l=this.config.inviteConfig)==null?void 0:l.onAccept)==null||r.call(l)};const a=document.createElement("button");a.textContent=((x=this.config.inviteConfig)==null?void 0:x.rejectText)||"稍后再说",a.style.cssText=`
      padding: 8px 16px;
