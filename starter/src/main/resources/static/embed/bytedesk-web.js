var BytedeskWeb=function(){"use strict";var z=Object.defineProperty;var W=(p,r,t)=>r in p?z(p,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[r]=t;var c=(p,r,t)=>W(p,typeof r!="symbol"?r+"":r,t);class p{constructor(t){c(this,"config");c(this,"bubble",null);c(this,"window",null);c(this,"inviteDialog",null);c(this,"contextMenu",null);c(this,"hideTimeout",null);c(this,"isVisible",!1);c(this,"isDragging",!1);c(this,"windowState","normal");c(this,"loopCount",0);c(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var h,u,f,g,y,b,T,M,I,k,D,$;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((h=this.config.bubbleConfig)!=null&&h.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const l=document.createElement("div");l.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const x=document.createElement("span");x.textContent=((g=this.config.bubbleConfig)==null?void 0:g.icon)||"",x.style.fontSize="20px",l.appendChild(x);const w=document.createElement("div"),m=document.createElement("div");m.textContent=((y=this.config.bubbleConfig)==null?void 0:y.title)||"",m.style.fontWeight="bold",m.style.color=((b=this.config.theme)==null?void 0:b.mode)==="dark"?"#e5e7eb":"#1f2937",m.style.marginBottom="4px",w.appendChild(m);const d=document.createElement("div");d.textContent=((T=this.config.bubbleConfig)==null?void 0:T.subtitle)||"",d.style.fontSize="0.9em",d.style.color=((M=this.config.theme)==null?void 0:M.mode)==="dark"?"#9ca3af":"#4b5563",w.appendChild(d),l.appendChild(w),e.appendChild(l);const C=document.createElement("div");C.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `,e.appendChild(C),e.appendChild(v),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button");const i=this.config.buttonConfig||{},n=i.width||60,o=i.height||60,a=Math.min(n,o)/2;this.bubble.style.cssText=`
    ...
    `;const s=document.createElement("div");if(s.style.cssText=`
      ...
      justify-content: center;
      gap: 8px;
    `,i.icon){const l=document.createElement("span");l.textContent=i.icon,l.style.fontSize=`${o*.4}px`,s.appendChild(l)}else{const l=document.createElement("div");l.innerHTML=`
      ...
      `,s.appendChild(l)}if(this.bubble.appendChild(s),this.bubble.addEventListener("mouseenter",()=>{this.bubble.style.transform="scale(1.1)"}),this.bubble.addEventListener("mouseleave",()=>{this.bubble.style.transform="scale(1)"}),t.appendChild(this.bubble),this.config.draggable){let l=0,x=0,w=0,m=0;this.bubble.addEventListener("mousedown",d=>{d.button===0&&(this.isDragging=!0,l=d.clientX,x=d.clientY,w=t.offsetLeft,m=t.offsetTop,t.style.transition="none")}),document.addEventListener("mousemove",d=>{if(!this.isDragging)return;d.preventDefault();const C=d.clientX-l,v=d.clientY-x,E=w+C,S=m+v,L=window.innerHeight-t.offsetHeight;E<=window.innerWidth/2?(t.style.left=`${Math.max(0,E)}px`,t.style.right="auto",this.config.placement="bottom-left"):(t.style.right=`${Math.max(0,window.innerWidth-E-t.offsetWidth)}px`,t.style.left="auto",this.config.placement="bottom-right"),t.style.bottom=`${Math.min(Math.max(0,window.innerHeight-S-t.offsetHeight),L)}px`}),document.addEventListener("mouseup",()=>{this.isDragging&&(this.isDragging=!1,t.style.transition="all 0.3s ease",this.config.marginSide=parseInt(this.config.placement==="bottom-left"?t.style.left:t.style.right)||20,this.config.marginBottom=parseInt(t.style.bottom||"20"))})}this.bubble.addEventListener("click",()=>{if(!this.isDragging){console.log("bubble click");const l=this.bubble.messageElement;l instanceof HTMLElement&&(l.style.display="none"),this.showChat()}}),this.bubble.messageElement=e,document.body.appendChild(t),this.bubble.addEventListener("contextmenu",l=>{this.showContextMenu(l)}),document.addEventListener("click",()=>{this.hideContextMenu()})}getSupportText(){const t=this.config.locale||"zh-cn",e={"zh-cn":"微语技术支持",en:"Powered by Weiyuai","ja-JP":"Weiyuaiによる技術支援","ko-KR":"Weiyuai 기술 지원"};return e[t]||e["zh-cn"]}createChatWindow(){var s,h,u,f,g,y;this.window=document.createElement("div");const t=window.innerWidth<=768,e=window.innerWidth,i=window.innerHeight,n=Math.min(((s=this.config.window)==null?void 0:s.width)||e*.9,e*.9),o=Math.min(((h=this.config.window)==null?void 0:h.height)||i*.9,i*.9);t?this.window.style.cssText=`
        ...
        overflow: hidden;
        transition: all ${(u=this.config.animation)==null?void 0:u.duration}ms ${(f=this.config.animation)==null?void 0:f.type};
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(g=this.config.animation)==null?void 0:g.duration}ms ${(y=this.config.animation)==null?void 0:y.type};
