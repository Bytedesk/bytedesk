var BytedeskWeb=function(){"use strict";var H=Object.defineProperty;var _=(C,u,t)=>u in C?H(C,u,{enumerable:!0,configurable:!0,writable:!0,value:t}):C[u]=t;var g=(C,u,t)=>_(C,typeof u!="symbol"?u+"":u,t);class C{constructor(t){g(this,"config");g(this,"bubble",null);g(this,"window",null);g(this,"inviteDialog",null);g(this,"contextMenu",null);g(this,"hideTimeout",null);g(this,"isVisible",!1);g(this,"isDragging",!1);g(this,"windowState","normal");g(this,"loopCount",0);g(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var f,x,w,l,a,y,$,I,D,S,L,z,B;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((f=this.config.bubbleConfig)!=null&&f.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `,s.setAttribute("data-placement",this.config.placement||"bottom-right");const v=document.createElement("span");v.textContent=((l=this.config.bubbleConfig)==null?void 0:l.icon)||"",v.style.fontSize="20px",s.appendChild(v);const E=document.createElement("div"),b=document.createElement("div");b.textContent=((a=this.config.bubbleConfig)==null?void 0:a.title)||"",b.style.fontWeight="bold",b.style.color=((y=this.config.theme)==null?void 0:y.mode)==="dark"?"#e5e7eb":"#1f2937",b.style.marginBottom="4px",b.style.textAlign=this.config.placement==="bottom-left"?"left":"right",E.appendChild(b);const r=document.createElement("div");r.textContent=(($=this.config.bubbleConfig)==null?void 0:$.subtitle)||"",r.style.fontSize="0.9em",r.style.color=((I=this.config.theme)==null?void 0:I.mode)==="dark"?"#9ca3af":"#4b5563",r.style.textAlign=this.config.placement==="bottom-left"?"left":"right",E.appendChild(r),s.appendChild(E),e.appendChild(s);const T=document.createElement("div");T.style.cssText=`
        position: absolute;
        bottom: -6px;
    ...
    `,e.textContent=this.config.inviteConfig.text||"需要帮助吗？点击开始对话",this.inviteDialog.appendChild(e);const i=document.createElement("div");i.style.cssText=`
      ...
      gap: 10px;
      justify-content: center;
    `;const n=document.createElement("button");n.textContent=((c=(p=this.config)==null?void 0:p.inviteConfig)==null?void 0:c.acceptText)||"开始对话";const o=((f=this.config.theme)==null?void 0:f.backgroundColor)||(t?"#3B82F6":"#0066FF");n.style.cssText=`
      padding: 8px 16px;
      background: ${o};
      color: white;
      border: none;
