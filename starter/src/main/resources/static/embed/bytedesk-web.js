var BytedeskWeb=function(){"use strict";var H=Object.defineProperty;var _=(C,u,t)=>u in C?H(C,u,{enumerable:!0,configurable:!0,writable:!0,value:t}):C[u]=t;var f=(C,u,t)=>_(C,typeof u!="symbol"?u+"":u,t);class C{constructor(t){f(this,"config");f(this,"bubble",null);f(this,"window",null);f(this,"inviteDialog",null);f(this,"contextMenu",null);f(this,"hideTimeout",null);f(this,"isVisible",!1);f(this,"isDragging",!1);f(this,"windowState","normal");f(this,"loopCount",0);f(this,"loopTimer",null);this.config={...this.getDefaultConfig(),...t}}getDefaultConfig(){return{isDebug:!1,isPreload:!1,baseUrl:"https://cdn.weiyuai.cn/chat",placement:"bottom-right",marginBottom:20,marginSide:20,autoPopup:!1,inviteConfig:{show:!1,text:"邀请您加入对话",acceptText:"开始对话",rejectText:"稍后再说"},tabsConfig:{home:!1,messages:!0,help:!1,news:!1},bubbleConfig:{show:!0,icon:"👋",title:"需要帮助吗？",subtitle:"点击开始对话"},buttonConfig:{show:!0,width:60,height:60,onClick:()=>{this.showChat()}},showSupport:!0,chatConfig:{org:"df_org_uid",t:"2",sid:"df_rt_uid"},animation:{enabled:!0,duration:300,type:"ease"},theme:{mode:"system",textColor:"#ffffff",backgroundColor:"#0066FF"},window:{width:380,height:640},draggable:!1,locale:"zh-cn"}}init(){var t;this.createBubble(),this.createInviteDialog(),this.setupMessageListener(),this.setupResizeListener(),this.preload(),this.config.autoPopup&&setTimeout(()=>{this.showChat()},this.config.autoPopupDelay||1e3),(t=this.config.inviteConfig)!=null&&t.show&&setTimeout(()=>{this.showInviteDialog()},this.config.inviteConfig.delay||3e3)}createBubble(){var g,b,x,l,a,w,I,$,D,S,L,z,B;const t=document.createElement("div");t.style.cssText=`
    ...
    `;let e=null;if((g=this.config.bubbleConfig)!=null&&g.show){e=document.createElement("div"),e.style.cssText=`
      ...
      `;const s=document.createElement("div");s.style.cssText=`
        ...
        align-items: center;
        gap: 8px;
      `;const v=document.createElement("span");v.textContent=((l=this.config.bubbleConfig)==null?void 0:l.icon)||"",v.style.fontSize="20px",s.appendChild(v);const E=document.createElement("div"),y=document.createElement("div");y.textContent=((a=this.config.bubbleConfig)==null?void 0:a.title)||"",y.style.fontWeight="bold",y.style.color=((w=this.config.theme)==null?void 0:w.mode)==="dark"?"#e5e7eb":"#1f2937",y.style.marginBottom="4px",E.appendChild(y);const r=document.createElement("div");r.textContent=((I=this.config.bubbleConfig)==null?void 0:I.subtitle)||"",r.style.fontSize="0.9em",r.style.color=(($=this.config.theme)==null?void 0:$.mode)==="dark"?"#9ca3af":"#4b5563",E.appendChild(r),s.appendChild(E),e.appendChild(s);const T=document.createElement("div");T.style.cssText=`
        position: absolute;
        bottom: -6px;
      ...
      `,e.appendChild(T),e.appendChild(M),t.appendChild(e),setTimeout(()=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")},500)}this.bubble=document.createElement("button");const i=this.config.buttonConfig||{},n=i.width||60,o=i.height||60,h=Math.min(n,o)/2,d=((L=this.config.theme)==null?void 0:L.mode)==="dark",m=d?"#3B82F6":"#0066FF",p=((z=this.config.theme)==null?void 0:z.backgroundColor)||m;this.bubble.style.cssText=`
      background-color: ${p};
      width: ${n}px;
      height: ${o}px;
      border-radius: ${h}px;
    ...
    `,i.icon){const s=document.createElement("span");s.textContent=i.icon,s.style.fontSize=`${o*.4}px`,c.appendChild(s)}else{const s=document.createElement("div");s.innerHTML=`
      ...
      `:this.window.style.cssText=`
        ...
        overflow: hidden;
        z-index: 10000;
        transition: all ${(g=this.config.animation)==null?void 0:g.duration}ms ${(b=this.config.animation)==null?void 0:b.type};
    ...
    `,h.src=this.generateChatUrl(),console.log("iframe.src: ",h.src),this.window.appendChild(h),this.config.showSupport){const l=document.createElement("div"),a=((x=this.config.theme)==null?void 0:x.mode)==="dark";l.style.cssText=`
        height: 24px;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    `,e.textContent=this.config.inviteConfig.text||"需要帮助吗？点击开始对话",this.inviteDialog.appendChild(e);const i=document.createElement("div");i.style.cssText=`
      ...
      gap: 10px;
      justify-content: center;
    `;const n=document.createElement("button");n.textContent=((c=(p=this.config)==null?void 0:p.inviteConfig)==null?void 0:c.acceptText)||"开始对话";const o=((g=this.config.theme)==null?void 0:g.backgroundColor)||(t?"#3B82F6":"#0066FF");n.style.cssText=`
      padding: 8px 16px;
      background: ${o};
      color: white;
      border: none;
      border-radius: 4px;
      cursor: pointer;
    `,n.onclick=()=>{var l,a,w;this.hideInviteDialog(),this.showChat(),(w=(a=(l=this.config)==null?void 0:l.inviteConfig)==null?void 0:a.onAccept)==null||w.call(a)};const h=document.createElement("button");h.textContent=((x=(b=this.config)==null?void 0:b.inviteConfig)==null?void 0:x.rejectText)||"稍后再说",h.style.cssText=`
      padding: 8px 16px;
