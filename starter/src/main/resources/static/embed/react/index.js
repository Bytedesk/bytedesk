...
var o = (e) => Array.isArray(e) ? e.map(o) : typeof e == "function" ? e.toString() : e && typeof e == "object" ? Object.keys(e).sort().reduce((t, n) => (t[n] = o(e[n]), t), {}) : e, s = (e) => JSON.stringify(o(e)), c = ({ locale: t = "zh-cn", ...n }) => /* @__PURE__ */ a(i, {
	messages: e[t],
	locale: t,
	defaultLocale: "zh-cn",
	...
	return n(() => (u++, l ? (i.current = l, window.bytedesk = l, l.setConfig(c, {
		replaceChatConfig: !0,
		replaceTabsConfig: !0
	}), a.current || (a.current = !0, o?.())) : (l = new t(c), i.current = l, window.bytedesk = l, l.init().then(() => {
		a.current = !0, o?.();
	}).catch((e) => {
