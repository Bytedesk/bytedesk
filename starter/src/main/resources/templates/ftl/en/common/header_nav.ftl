...
<header class="navbar-light navbar-sticky navbar-transparent">
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container">
			<!-- Logo START -->
			<a class="navbar-brand me-0" href="https://ai.bytedesk.com/">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link active" href="https://ai.bytedesk.com/" id="demoMenu">Home</a>
					</li>

					<!-- Nav item 2 Course -->
					<li class="nav-item dropdown"><a class="nav-link" href="https://docs.bytedesk.com/" target="_blank">Docs</a></li>
			...
			<div class="navbar-nav ms-3 d-none d-sm-block">
				<button class="btn btn-sm btn-dark mb-0" onclick="window.open('https://admin.bytedesk.com/')">Getting Started</button>
			</div>
