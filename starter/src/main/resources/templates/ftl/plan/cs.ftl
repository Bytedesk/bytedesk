...
<html lang="en">
<head>
	<title>在线客服 - 开源智能客服系统 - 企业IM、在线客服、AI客服、知识库AI问答</title>

	<#--  Header  -->
	<#include "/plan/common/header_meta.ftl" />
	<#include "/plan/common/header_js.ftl" />
	<#include "/plan/common/header_css.ftl" />
...
<#--  导航  -->
<#include "/plan/common/header_nav.ftl" />
				...
				<div class="bg-light p-4 p-sm-5 rounded-3 position-relative overflow-hidden">
					...
					<div class="row g-4 justify-content-center align-items-center position-relative">
						...
						<div class="col-lg-3 text-center text-lg-end z-index-9">
							<a href="https://www.weiyuai.cn/download.html" class="btn btn-warning mb-0">去下载</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- ======================= Footer START -->
<#include "/plan/common/footer_nav.ftl" />
<!-- ======================= Footer END -->

<#include "/plan/common/footer_js.ftl" />

<#-- livechat code 客服代码  -->
<#include "/plan/common/bytedesk.ftl" />

<#-- trace code 统计代码  -->
<#include "/plan/common/track.ftl" />
