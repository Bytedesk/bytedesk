                    ...
                    <ul id="supportCategory" class="uk-list uk-list-large uk-margin-medium-bottom">
                        <#list categories as category>
                            <button class="accordion">
                                <a href="category_${category.cid}.html" target="_blank">${category.name!''}</a>
                            </button>
                        </#list>
                ...
                <div class="uk-width-3-4@m uk-flex-last@m">
                    ...
                    <ul id="supportCategoryArticle" class="uk-list list-category link-icon-right">
                        ...
                        <#list articles as article>
                            <li>
                                <a href="article_${article.aid}.html" target="_blank">${article.title!''}<span style="float: right;">${article.updatedAt?substring(5, 16)}</span></a>
                            </li>
                        </#list>
                        <#if (articles?size == 0)>
                            <div>
