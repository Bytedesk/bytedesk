...
public class Context implements IModEslApi {
	 ...
	 * server.
	 * <p/>
	 * The outcome of the command from the server is returned in an {@link com.bytedesk.call.esl.client.transport.message.EslMessage} object.
	 *
	 * @param command a mod_event_socket command to send
	 * @return an {@link com.bytedesk.call.esl.client.transport.message.EslMessage} containing command results
	 */
	 ...
	 * @return a {@link com.bytedesk.call.esl.client.transport.CommandResponse} with the server's response.
	 */
	@Override
