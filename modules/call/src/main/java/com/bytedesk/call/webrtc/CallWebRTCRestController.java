...
public class CallWebRTCRestController extends BaseRestController<CallWebRTCRequest, CallWebRTCRestService> {
    ...
    @Override
    public ResponseEntity<?> queryByOrg(CallWebRTCRequest request) {
        
        Page<CallWebRTCResponse> webrtcPage = freeswitchWebRTCRestService.queryByOrg(request);
    ...
    @Override
    public ResponseEntity<?> queryByUser(CallWebRTCRequest request) {
        
        Page<CallWebRTCResponse> webrtcPage = freeswitchWebRTCRestService.queryByUser(request);
    ...
    @Override
    public ResponseEntity<?> queryByUid(CallWebRTCRequest request) {
        
        CallWebRTCResponse webrtc = freeswitchWebRTCRestService.queryByUid(request);
    ...
    public ResponseEntity<?> create(CallWebRTCRequest request) {
        
        CallWebRTCResponse webrtc = freeswitchWebRTCRestService.create(request);
    ...
    public ResponseEntity<?> update(CallWebRTCRequest request) {
        
        CallWebRTCResponse webrtc = freeswitchWebRTCRestService.update(request);
    ...
    public ResponseEntity<?> delete(CallWebRTCRequest request) {
    ...
    @GetMapping("/export")
    public Object export(CallWebRTCRequest request, HttpServletResponse response) {
        return exportTemplate(
            request,
            response,
            freeswitchWebRTCRestService,
            CallWebRTCExcel.class,
            "视频客服",
            "webrtc"
        );
    }
