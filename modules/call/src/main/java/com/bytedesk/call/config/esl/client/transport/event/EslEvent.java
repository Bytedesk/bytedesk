 ...
 */
package com.bytedesk.call.config.esl.client.transport.event;
...
import com.bytedesk.call.config.esl.client.transport.HeaderParser;
...
import com.bytedesk.call.config.esl.client.transport.message.EslHeaders.Name;
import com.bytedesk.call.config.esl.client.transport.message.EslHeaders.Value;
...
public class EslEvent {
	...
	public String toString() {
		return new StringJoiner(", ", EslEvent.class.getSimpleName() + "{", "}")
