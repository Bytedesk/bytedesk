...
/**
 * Event published when a new esl_event is created.
 */
public class EslEventCreateEvent extends AbstractEslEventEvent {

    private static final long serialVersionUID = 1L;

    public EslEventCreateEvent(EslEventEntity esl_event) {
