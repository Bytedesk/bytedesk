...
/**
 * Event published when an existing esl_event is updated.
 */
public class EslEventUpdateEvent extends AbstractEslEventEvent {

    private static final long serialVersionUID = 1L;

    public EslEventUpdateEvent(EslEventEntity esl_event) {
