 ...
 * Call会议室查询规范
 */
public class CallConferenceSpecification {

    /**
     * 构建查询条件
     */
    public static Specification<CallConferenceEntity> build(CallConferenceRequest request) {
     ...
     * 按会议室名称搜索
     */
    public static Specification<CallConferenceEntity> conferenceName(String conferenceName) {
        return (root, query, criteriaBuilder) -> {
     ...
     * 按启用状态过滤
     */
    public static Specification<CallConferenceEntity> enabled(Boolean enabled) {
        return (root, query, criteriaBuilder) -> {
            if (enabled == null) {
                return null;
            }
     ...
     * 按录音状态过滤
     */
    public static Specification<CallConferenceEntity> recordEnabled(Boolean recordEnabled) {
        return (root, query, criteriaBuilder) -> {
     ...
     * 按创建者过滤
     */
    public static Specification<CallConferenceEntity> creator(String creator) {
        return (root, query, criteriaBuilder) -> {
     ...
     * 按最大成员数范围过滤
     */
    public static Specification<CallConferenceEntity> maxMembersBetween(Integer minMembers, Integer maxMembers) {
        return (root, query, criteriaBuilder) -> {
     ...
     * 按密码保护状态过滤
     */
    public static Specification<CallConferenceEntity> passwordProtected(Boolean passwordProtected) {
        return (root, query, criteriaBuilder) -> {
