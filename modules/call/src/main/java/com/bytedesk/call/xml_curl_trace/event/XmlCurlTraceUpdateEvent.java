...
/**
 * Event published when an existing xml_curl_trace is updated.
 */
public class XmlCurlTraceUpdateEvent extends AbstractXmlCurlTraceEvent {

    private static final long serialVersionUID = 1L;

    public XmlCurlTraceUpdateEvent(XmlCurlTraceEntity xml_curl_trace) {
