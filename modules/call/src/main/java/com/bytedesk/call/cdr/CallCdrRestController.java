...
public class CallCdrRestController extends BaseRestController<CallCdrRequest, CallCdrRestService> {
    ...
    public ResponseEntity<?> queryByOrg(CallCdrRequest request) {
        ...
        Page<CallCdrResponse> cdrs = callCdrRestService.queryByOrg(request);
    ...
    public ResponseEntity<?> queryByUser(CallCdrRequest request) {
        ...
        Page<CallCdrResponse> cdrs = callCdrRestService.queryByUser(request);
    ...
    public ResponseEntity<?> queryByUid(CallCdrRequest request) {
        ...
        CallCdrResponse cdr = callCdrRestService.queryByUid(request);
    ...
    public ResponseEntity<?> create(CallCdrRequest request) {
        ...
        CallCdrResponse cdr = callCdrRestService.create(request);
    ...
    public ResponseEntity<?> update(CallCdrRequest request) {
        ...
        CallCdrResponse cdr = callCdrRestService.update(request);
    ...
    public ResponseEntity<?> delete(CallCdrRequest request) {
        ...
        callCdrRestService.deleteByUid(request.getUid());

        return ResponseEntity.ok(JsonResult.success("删除成功", request.getUid()));
    }

    @ActionAnnotation(title = "Call通话详单", action = "删除", description = "delete freeswitch cdr by org")
    @Override
    public ResponseEntity<?> deleteByOrgUid(@RequestBody CallCdrRequest request) {

        callCdrRestService.deleteByOrgUid(request.getOrgUid());
        
        return ResponseEntity.ok(JsonResult.success("删除成功", request.getOrgUid()));
    }
