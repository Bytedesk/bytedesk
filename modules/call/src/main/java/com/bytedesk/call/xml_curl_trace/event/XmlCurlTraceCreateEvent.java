...
/**
 * Event published when a new xml_curl_trace is created.
 */
public class XmlCurlTraceCreateEvent extends AbstractXmlCurlTraceEvent {

    private static final long serialVersionUID = 1L;

    public XmlCurlTraceCreateEvent(XmlCurlTraceEntity xml_curl_trace) {
