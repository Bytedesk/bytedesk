...
/**
 * Event published when a new gateway is created.
 */
public class GatewayCreateEvent extends AbstractGatewayEvent {

    private static final long serialVersionUID = 1L;

    public GatewayCreateEvent(GatewayEntity gateway) {
