...
/**
 * Event published when an existing gateway is updated.
 */
public class GatewayUpdateEvent extends AbstractGatewayEvent {

    private static final long serialVersionUID = 1L;

    public GatewayUpdateEvent(GatewayEntity gateway) {
