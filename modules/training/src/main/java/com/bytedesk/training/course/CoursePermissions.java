...
public class CoursePermissions extends BasePermissions {
    ...
    public static final String HAS_COURSE_READ = "hasAuthority('" + COURSE_READ + "')";
    public static final String HAS_COURSE_CREATE = "hasAuthority('" + COURSE_CREATE + "')";
    public static final String HAS_COURSE_UPDATE = "hasAuthority('" + COURSE_UPDATE + "')";
    public static final String HAS_COURSE_DELETE = "hasAuthority('" + COURSE_DELETE + "')";
    public static final String HAS_COURSE_EXPORT = "hasAuthority('" + COURSE_EXPORT + "')";
