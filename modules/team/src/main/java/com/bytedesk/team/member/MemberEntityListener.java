 ...
 * @LastEditTime: 2024-08-05 11:21:32
...
public class MemberEntityListener {
    ...
    public void postPersist(Member member) {
        ...
        bytedeskEventPublisher.publishGenericApplicationEvent(new GenericApplicationEvent<MemberCreateEvent>(this, new MemberCreateEvent(this, clonedMember)));
        // 默认订阅成员主题
    ...
    public void postUpdate(Member member) {
        ...
        // 
        BytedeskEventPublisher bytedeskEventPublisher = ApplicationContextHolder.getBean(BytedeskEventPublisher.class);
        bytedeskEventPublisher.publishGenericApplicationEvent(new GenericApplicationEvent<MemberUpdateEvent>(this, new MemberUpdateEvent(this, clonedMember)));
