...
public class RobotSettingsRestService
    ...
    public RobotSettingsResponse create(RobotSettingsRequest request) {
        ...
        syncOrgUser(svc, orgUid, userUid);
        ...
        syncOrgUser(tools, orgUid, userUid);
        ...
        syncOrgUser(toolsDraft, orgUid, userUid);
    ...
    public RobotSettingsResponse update(RobotSettingsRequest request) {
        ...
        if (request.getHideThinkingProcess() != null) {
            entity.setHideThinkingProcess(request.getHideThinkingProcess());
        }
