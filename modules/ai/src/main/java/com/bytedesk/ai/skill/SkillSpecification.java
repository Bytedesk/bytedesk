...
@Slf4j
public class SkillSpecification extends BaseSpecification<SkillEntity, SkillRequest> {
    
    public static Specification<SkillEntity> search(SkillRequest request, AuthService authService) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // 使用带层级过滤的基础条件
            predicates.addAll(getBasicPredicatesWithLevel(root, criteriaBuilder, request, authService, SkillPermissions.MODULE_NAME));
            // name
