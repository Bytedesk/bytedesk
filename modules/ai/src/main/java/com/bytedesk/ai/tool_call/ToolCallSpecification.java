...
@Slf4j
public class ToolCallSpecification extends BaseSpecification<ToolCallEntity, ToolCallRequest> {
    
    public static Specification<ToolCallEntity> search(ToolCallRequest request, AuthService authService) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // 使用带层级过滤的基础条件
            predicates.addAll(getBasicPredicatesWithLevel(root, criteriaBuilder, request, authService, ToolCallPermissions.MODULE_NAME));
            // name
