...
@AllArgsConstructor
@NoArgsConstructor
// @EntityListeners({McpClientEntityListener.class})
@Table(name = "bytedesk_ai_mcp_client")
public class McpClientEntity extends BaseEntity {
     ...
     */
    @Builder.Default
    @Column(name = "mcp_client_type")
    private String type = McpClientTypeEnum.CUSTOMER.name();
