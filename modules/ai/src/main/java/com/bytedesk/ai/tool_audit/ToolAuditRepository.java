...
public interface ToolAuditRepository extends JpaRepository<ToolAuditEntity, Long>, JpaSpecificationExecutor<ToolAuditEntity> {

    Optional<ToolAuditEntity> findByUid(String uid);
