...
@Slf4j
public class McpServerSpecification extends BaseSpecification<McpServerEntity, McpServerRequest> {
    
    public static Specification<McpServerEntity> search(McpServerRequest request, AuthService authService) {
