 ...
 * @LastEditTime: 2024-09-26 10:47:20
...
@AllArgsConstructor
public class LlmProviderKeyController extends BaseController<LlmProviderKeyRequest> {
    ...
    @Override
    public ResponseEntity<?> query(LlmProviderKeyRequest request) {
