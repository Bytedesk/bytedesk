...
/**
 * Event published when a tool_call is deleted.
 */
public class ToolCallDeleteEvent extends AbstractToolCallEvent {

    private static final long serialVersionUID = 1L;

    public ToolCallDeleteEvent(ToolCallEntity tool_call) {
