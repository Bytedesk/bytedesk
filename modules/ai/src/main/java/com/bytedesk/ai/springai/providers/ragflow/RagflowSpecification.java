 ...
 * @LastEditTime: 2025-08-25 14:01:01
...
@Slf4j
public class RagflowSpecification extends BaseSpecification<RagflowEntity, RagflowRequest> {
    
    public static Specification<RagflowEntity> search(RagflowRequest request, AuthService authService) {
