...
/**
 * Event published when a tool_guard is deleted.
 */
public class ToolGuardDeleteEvent extends AbstractToolGuardEvent {

    private static final long serialVersionUID = 1L;

    public ToolGuardDeleteEvent(ToolGuardEntity tool_guard) {
