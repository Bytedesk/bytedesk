...
@Slf4j
public class McpClientSpecification extends BaseSpecification<McpClientEntity, McpClientRequest> {

    // 模块名称，用于权限检查
    private static final String MODULE_NAME = "MCPCLIENT";
    
    public static Specification<McpClientEntity> search(McpClientRequest request, AuthService authService) {
