 ...
 */
@Slf4j
public class RobotSettingsSpecification extends BaseSpecification<RobotSettingsEntity, RobotSettingsRequest> {

    public static Specification<RobotSettingsEntity> search(RobotSettingsRequest request, AuthService authService) {
