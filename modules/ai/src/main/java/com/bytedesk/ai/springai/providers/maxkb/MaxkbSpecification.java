 ...
 * @LastEditTime: 2025-08-25 14:00:47
...
@Slf4j
public class MaxkbSpecification extends BaseSpecification<MaxkbEntity, MaxkbRequest> {
    
    public static Specification<MaxkbEntity> search(MaxkbRequest request, AuthService authService) {
