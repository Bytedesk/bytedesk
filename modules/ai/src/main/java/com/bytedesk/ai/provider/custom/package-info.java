 ...
 * <p>主要组件：</p>
 * <ul>
 *   <li>{@link com.bytedesk.ai.provider.custom.SpringAICustomService} - 自定义 AI 服务实现，提供对话生成、FAQ 生成等核心功能</li>
 *   <li>{@link com.bytedesk.ai.springai.providers.custom.SpringAICustomConfig} - 自定义 AI 服务配置类，包含 API端点、密钥和模型设置</li>
 *   <li>{@link com.bytedesk.ai.provider.custom.SpringAICustomChatController} - 自定义 AI 服务的REST API 控制器</li>
