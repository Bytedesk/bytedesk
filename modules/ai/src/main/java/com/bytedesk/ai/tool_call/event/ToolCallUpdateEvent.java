...
/**
 * Event published when an existing tool_call is updated.
 */
public class ToolCallUpdateEvent extends AbstractToolCallEvent {

    private static final long serialVersionUID = 1L;

    public ToolCallUpdateEvent(ToolCallEntity tool_call) {
