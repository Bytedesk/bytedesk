 ...
 * @LastEditTime: 2024-09-25 18:20:39
...
@AllArgsConstructor
public class LlmProviderController extends BaseController<LlmProviderRequest> {
    ...
    public ResponseEntity<?> queryByOrg(LlmProviderRequest request) {
        ...
        Page<LlmProviderResponse> page = service.queryByOrg(request);

        return ResponseEntity.ok(JsonResult.success(page));
    }

    @Override
    public ResponseEntity<?> query(LlmProviderRequest request) {
    ...
    public ResponseEntity<?> update(LlmProviderRequest request) {
        ...
        LlmProviderResponse response = service.update(request);
