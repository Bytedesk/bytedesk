...
import static com.bytedesk.ai.springai.providers.moonshot.api.MoonshotConstants.DEFAULT_BASE_URL;
import static com.bytedesk.ai.springai.providers.moonshot.api.MoonshotConstants.DEFAULT_COMPLETIONS_PATH;
...
public class MoonshotApi {
	...
	// @formatter:off
			...
			@JsonProperty("thinking") com.bytedesk.ai.springai.providers.moonshot.api.MoonshotChatOptions.Thinking thinking) {
		 // @formatter:on
