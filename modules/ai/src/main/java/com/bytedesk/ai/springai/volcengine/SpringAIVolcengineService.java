 ...
 * @LastEditTime: 2025-04-11 10:55:16
...
public class SpringAIVolcengineService extends BaseSpringAIService {
    ...
    private final Optional<OpenAiChatModel> volcengineChatModel;

    public SpringAIVolcengineService(
            Optional<OpenAiChatModel> volcengineChatModel,
        ...
        super(springAIVectorService, messageSendService, uidUtils, robotRestService, threadRestService,
                messagePersistCache);
        this.volcengineChatModel = volcengineChatModel;
