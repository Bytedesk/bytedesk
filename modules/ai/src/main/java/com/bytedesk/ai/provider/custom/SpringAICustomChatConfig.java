 ...
 * @LastEditTime: 2025-07-18 11:46:09
...
public class SpringAICustomChatConfig {
    ...
    ChatClient customChatClient(ChatClientBuilderFactory chatClientBuilderFactory) {
        return  chatClientBuilderFactory.builder(customChatModel())
