...
public class DashscopeChatService extends BaseSpringAIService {
    ...
    protected String processPromptSync(String message, RobotProtobuf robot) {
        ...
        DashScopeChatOptions customOptions = robot != null && robot.getLlm() != null ? createDynamicOptions(robot.getLlm()) : null;
