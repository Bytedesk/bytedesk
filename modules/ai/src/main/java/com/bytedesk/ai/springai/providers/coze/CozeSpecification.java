...
@Slf4j
public class CozeSpecification extends BaseSpecification<CozeEntity, CozeRequest> {
    
    public static Specification<CozeEntity> search(CozeRequest request, AuthService authService) {
