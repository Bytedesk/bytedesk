 ...
 * @LastEditTime: 2025-07-16 13:52:02
    ...
    protected void processPromptWebsocket(Prompt prompt, RobotProtobuf robot, MessageProtobuf messageProtobufQuery, MessageProtobuf messageProtobufReply, String fullPromptContent) {
        ...
        bytedeskDashscopeChatModel.stream(requestPrompt).subscribe(
                ...
                () -> {
                    ...
                    String modelType = (llm != null && StringUtils.hasText(llm.getChatModel())) ? llm.getChatModel() : "qwen-turbo";
    ...
    protected String processPromptSync(String message, RobotProtobuf robot, String fullPromptContent) {
        ...
        try {
            ...
            String modelType = (robot != null && robot.getLlm() != null && StringUtils.hasText(robot.getLlm().getChatModel())) 
                    ? robot.getLlm().getChatModel() : "qwen-turbo";
            recordAiTokenUsage(robot, LlmConsts.DASHSCOPE, modelType, 
        ...
        bytedeskDashscopeChatModel.stream(requestPrompt).subscribe(
                ...
                () -> {
                    ...
                    sendStreamEndMessage(messageProtobufQuery, messageProtobufReply, emitter, 
                            tokenUsage[0].getPromptTokens(), tokenUsage[0].getCompletionTokens(), tokenUsage[0].getTotalTokens(), fullPromptContent, LlmConsts.DASHSCOPE, (llm != null && StringUtils.hasText(llm.getChatModel())) ? llm.getChatModel() : "qwen-turbo");
                    // 记录token使用情况
                    long responseTime = System.currentTimeMillis() - startTime;
                    String modelType = (llm != null && StringUtils.hasText(llm.getChatModel())) ? llm.getChatModel() : "qwen-turbo";
                    recordAiTokenUsage(robot, LlmConsts.DASHSCOPE, modelType, 
