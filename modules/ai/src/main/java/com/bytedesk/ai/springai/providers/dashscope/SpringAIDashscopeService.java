        ...
        bytedeskDashscopeChatModel.stream(requestPrompt).subscribe(
                ...
                () -> {
                    ...
                    sendStreamEndMessage(messageProtobufQuery, messageProtobufReply, emitter, 
                            tokenUsage[0].getPromptTokens(), tokenUsage[0].getCompletionTokens(), tokenUsage[0].getTotalTokens(), fullPromptContent, LlmConsts.DASHSCOPE, (llm != null && StringUtils.hasText(llm.getModel())) ? llm.getModel() : "qwen-turbo");
                    // 记录token使用情况
                    long responseTime = System.currentTimeMillis() - startTime;
                    String modelType = (llm != null && StringUtils.hasText(llm.getModel())) ? llm.getModel() : "qwen-turbo";
                    recordAiTokenUsage(robot, LlmConsts.DASHSCOPE, modelType, 
