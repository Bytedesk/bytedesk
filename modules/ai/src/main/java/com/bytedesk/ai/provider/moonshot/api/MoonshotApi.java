...
package com.bytedesk.ai.provider.moonshot.api;
...
import static com.bytedesk.ai.provider.moonshot.api.MoonshotConstants.DEFAULT_BASE_URL;
import static com.bytedesk.ai.provider.moonshot.api.MoonshotConstants.DEFAULT_COMPLETIONS_PATH;
...
public class MoonshotApi {
	...
	// Moonshot may return extra fields not declared in the DTOs (e.g. "system_fingerprint"),
	// so unknown properties must not fail deserialization.
	 ...
	 * context length.
	 * @param maxCompletionTokens The preferred max completion tokens field for current
	 * Kimi API.
	...
	// @formatter:off
			...
			@JsonProperty("thinking") com.bytedesk.ai.provider.moonshot.api.MoonshotChatOptions.Thinking thinking) {
		 // @formatter:on
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model) {
			this(messages, model, null, null, 0.3, 1.0, null, null, null, null, false, null, null, null);
		}
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature,
				boolean stream) {
			this(messages, model, null, null, temperature, 1.0, null, null, null, null, stream, null, null, null);
		}
		 ...
		 */
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature) {
			this(messages, model, null, null, temperature, 1.0, null, null, null, null, false, null, null, null);
		}
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, List<FunctionTool> tools,
				Object toolChoice) {
			this(messages, model, null, null, null, 1.0, null, null, null, null, false, tools, toolChoice, null);
		}
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, Boolean stream) {
			this(messages, DEFAULT_CHAT_MODEL, null, null, 0.7, 1.0, null, null, null, null, stream, null, null, null);
		}
