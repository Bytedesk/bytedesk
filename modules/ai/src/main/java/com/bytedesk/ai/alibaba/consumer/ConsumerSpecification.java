...
@Slf4j
public class ConsumerSpecification extends BaseSpecification<ConsumerEntity, ConsumerRequest> {
    
    public static Specification<ConsumerEntity> search(ConsumerRequest request, AuthService authService) {
