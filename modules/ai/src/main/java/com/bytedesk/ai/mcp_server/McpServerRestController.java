 ...
 * @LastEditTime: 2025-09-26 14:35:19
...
public class McpServerRestController extends BaseRestController<McpServerRequest, McpServerRestService> {
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_QUERY_ORG, description = "query mcpServer by org")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_QUERY_USER, description = "query mcpServer by user")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_QUERY_DETAIL, description = "query mcpServer by uid")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_CREATE, description = "create mcpServer")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_UPDATE, description = "update mcpServer")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_DELETE, description = "delete mcpServer")
    ...
    @ActionAnnotation(title = I18Consts.I18N_MCP_SERVER, action = I18Consts.I18N_ACTION_EXPORT, description = "export mcpServer")
