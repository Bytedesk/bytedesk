 ...
 * @LastEditTime: 2025-08-21 13:39:11
 ...
 */
package com.bytedesk.ai.provider.custom;
...
public class SpringAICustomChatController {
    ...
    public ResponseEntity<JsonResult<?>> generate(
        ...
        OpenAiChatModel model = springAICustomService.getChatModel();
        if (model == null) {
            return ResponseEntity.ok(JsonResult.error("Custom service is not available"));
        }
    ...
    // structured output
    // http://127.0.0.1:9003/custom/structured?message=
    // https://docs.spring.io/spring-ai/reference/api/structured-output-converter.html
