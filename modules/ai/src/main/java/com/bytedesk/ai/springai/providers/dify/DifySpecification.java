 ...
 * @LastEditTime: 2025-08-25 14:00:35
...
@Slf4j
public class DifySpecification extends BaseSpecification<DifyEntity, DifyRequest> {
    
    public static Specification<DifyEntity> search(DifyRequest request, AuthService authService) {
