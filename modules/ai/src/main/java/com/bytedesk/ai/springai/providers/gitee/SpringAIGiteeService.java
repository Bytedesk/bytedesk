...
public class SpringAIGiteeService extends BaseSpringAIService {
     ...
     */
    private OpenAiChatModel createGiteeChatModel(RobotLlmResponse llm) {
        ...
        try {
            ...
            log.error("Failed to create dynamic Gitee chat model for provider {}, using default chat model", provider.getUid(), e);
            return defaultChatModel;
        }
    }
