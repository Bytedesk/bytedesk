...
/**
 * Event published when a new tool_rule is created.
 */
public class ToolRuleCreateEvent extends AbstractToolRuleEvent {

    private static final long serialVersionUID = 1L;

    public ToolRuleCreateEvent(ToolRuleEntity tool_rule) {
