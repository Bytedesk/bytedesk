...
public class SpringAIGeminiChatService extends BaseSpringAIService {
    ...
    //     geminiChatModel.stream(requestPrompt).subscribe(
    //             response -> {
    //                 if (response != null) {
    ...
    protected String processPromptSync(String message, RobotProtobuf robot) {
        ...
        try {
            ...
            try {
                ...
                var response = geminiChatModel.call(message);
                tokenUsage = tokenUsageHelper.extractTokenUsage(response);
                success = true;
                return promptHelper.extractTextFromResponse(response);
            } catch (Exception e) {
    ...
    protected void processPromptSse(Prompt prompt, RobotProtobuf robot, MessageProtobuf messageProtobufQuery,
        ...
        if (geminiChatModel == null) {
            sseMessageHelper.handleSseError(new RuntimeException("OpenAI service not available"), messageProtobufQuery,
