...
public class SpringAIVolcengineChatController {
    ...
    // structured output
    // http://127.0.0.1:9003/volcengine/structured?message=
    // https://docs.spring.io/spring-ai/reference/api/structured-output-converter.html
    ...
    /**
     * 方式1：同步调用
        * http://127.0.0.1:9003/volcengine/chat/sync?message=hello
     */
    ...
    /**
     * 方式2：异步流式调用
        * http://127.0.0.1:9003/volcengine/chat/stream?message=hello
     */
    ...
    /**
     * 方式3：SSE调用
        * http://127.0.0.1:9003/volcengine/chat/sse?message=hello
     */
    ...
    /**
     * 自定义模型参数的调用示例
        * http://127.0.0.1:9003/volcengine/chat/custom?message=hello
     */
