...
public class BytedeskDashScopeChatModel implements ChatModel {
    ...
    private final BytedeskDashScopeChatOptions defaultOptions;

    public BytedeskDashScopeChatModel(String baseUrl, String apiKey, BytedeskDashScopeChatOptions defaultOptions) {
        this.baseUrl = DashScopeBaseUrlSupport.normalize(baseUrl);
        this.apiKey = apiKey;
        this.defaultOptions = defaultOptions != null ? defaultOptions : BytedeskDashScopeChatOptions.builder().model(DEFAULT_MODEL).build();
    }
    ...
    private GenerationParam createParam(Prompt prompt, boolean stream) {
        BytedeskDashScopeChatOptions options = mergeOptions(prompt.getOptions());
    ...
    private String resolveModel(BytedeskDashScopeChatOptions options) {
