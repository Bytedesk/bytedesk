 ...
 * <p>主要组件：</p>
 * <ul>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterService} - OpenRouter 服务实现，提供对话生成等核心功能</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterChatService} - OpenRouter 聊天服务实现</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterRestService} - OpenRouter REST 服务，提供模型管理和配置功能</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterRestController} - OpenRouter REST API 控制器</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterChatController} - OpenRouter 聊天 API 控制器</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.SpringAIOpenrouterChatConfig} - OpenRouter 服务配置类</li>
 *   <li>{@link com.bytedesk.ai.provider.openrouter.OpenrouterRequest} - OpenRouter 请求参数封装类</li>
 * </ul>
 * 
 * <p>使用方法：</p>
 ...
 */
@NullMarked
package com.bytedesk.ai.provider.openrouter;
