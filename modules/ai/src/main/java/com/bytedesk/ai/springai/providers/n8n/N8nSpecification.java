 ...
 * @LastEditTime: 2025-08-25 14:00:56
...
@Slf4j
public class N8nSpecification extends BaseSpecification<N8nEntity, N8nRequest> {
    
    public static Specification<N8nEntity> search(N8nRequest request, AuthService authService) {
