 ...
 */
package com.bytedesk.ai.provider.dashscope.embedding;
...
public class DashscopeEmbeddingConfig {
    ...
    DashScopeEmbeddingModel dashscopeEmbeddingModel(ObservationRegistry observationRegistry) {
        String apiKey = dashscopeEmbeddingApiKey != null && !dashscopeEmbeddingApiKey.isEmpty()
                ? dashscopeEmbeddingApiKey
                : dashscopeApiKey;
        return new DashScopeEmbeddingModel(dashscopeBaseUrl, apiKey, bytedeskDashscopeEmbeddingOptions(), observationRegistry);
    }
