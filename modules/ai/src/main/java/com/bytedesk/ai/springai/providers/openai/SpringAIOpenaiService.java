 ...
 * @LastEditTime: 2025-04-29 12:10:43
...
public class SpringAIOpenaiService extends BaseSpringAIService {
    ...
    protected String generateFaqPairs(String prompt) {
        return openaiChatModel != null ? openaiChatModel.call(prompt) : "";
    }

    @Override
    protected String processPromptSync(String message) {
        try {
            return openaiChatModel != null ? openaiChatModel.call(message) : "Openai service is not available";
        } catch (Exception e) {
