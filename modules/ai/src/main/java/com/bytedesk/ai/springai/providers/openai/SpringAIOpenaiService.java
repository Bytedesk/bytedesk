    ...
    protected void processPromptWebsocket(Prompt prompt, RobotProtobuf robot, MessageProtobuf messageProtobufQuery, MessageProtobuf messageProtobufReply, String fullPromptContent) {
        ...
        openaiChatModel.stream(requestPrompt).subscribe(
                ...
                () -> {
                    ...
                    String modelType = (llm != null && StringUtils.hasText(llm.getModel())) ? llm.getModel() : "gpt-3.5-turbo";
    ...
    protected String processPromptSync(String message, RobotProtobuf robot, String fullPromptContent) {
        ...
        try {
            ...
            String modelType = (robot != null && robot.getLlm() != null && StringUtils.hasText(robot.getLlm().getModel())) 
                    ? robot.getLlm().getModel() : "gpt-3.5-turbo";
            recordAiTokenUsage(robot, LlmConsts.OPENAI, modelType, 
        ...
        openaiChatModel.stream(requestPrompt).subscribe(
                ...
                () -> {
                    ...
                    sendStreamEndMessage(messageProtobufQuery, messageProtobufReply, emitter, 
                            tokenUsage[0].getPromptTokens(), tokenUsage[0].getCompletionTokens(), tokenUsage[0].getTotalTokens(), fullPromptContent, LlmConsts.OPENAI, (llm != null && StringUtils.hasText(llm.getModel())) ? llm.getModel() : "gpt-3.5-turbo");
                    // 记录token使用情况
                    long responseTime = System.currentTimeMillis() - startTime;
                    String modelType = (llm != null && StringUtils.hasText(llm.getModel())) ? llm.getModel() : "gpt-3.5-turbo";
                    recordAiTokenUsage(robot, LlmConsts.OPENAI, modelType, 
