 ...
 * @LastEditTime: 2025-07-18 11:46:54
...
public class SpringAIOpenrouterChatConfig {
    ...
    ChatClient openrouterChatClient(ChatClientBuilderFactory chatClientBuilderFactory) {
        return  chatClientBuilderFactory.builder(openrouterChatModel())
