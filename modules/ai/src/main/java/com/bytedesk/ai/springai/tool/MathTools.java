...
public class MathTools {
    ...
    @Tool(description = "Add two numbers. This tool returns structured data for AI tool invocation.")
    public double add(
    ...
    @Tool(description = "Subtract the second number from the first. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Multiply two numbers. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Divide the first number by the second. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Calculate the square root of a number. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Compute the average of the provided numbers. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Calculate the percentage value. This tool returns structured data for AI tool invocation.")
