...
/**
 * Event published when a tool_rule is deleted.
 */
public class ToolRuleDeleteEvent extends AbstractToolRuleEvent {

    private static final long serialVersionUID = 1L;

    public ToolRuleDeleteEvent(ToolRuleEntity tool_rule) {
