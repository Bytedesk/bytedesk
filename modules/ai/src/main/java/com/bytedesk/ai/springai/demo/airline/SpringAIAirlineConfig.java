 ...
 * @LastEditTime: 2025-02-27 15:19:01
...
public class SpringAIAirlineConfig {
    ...
    public ChatClient customerSupportAssistant(ChatClient.Builder dashScopeChatClientBuilder,
        ...
        return dashScopeChatClientBuilder
                ...
                .defaultTools("getBookingDetails", "changeBooking", "cancelBooking") // TOOL CALLING
                .build();
    }
...
//                 .defaultAdvisors(
//                         new PromptChatMemoryAdvisor(defaultChatMemory), // Chat Memory
//                         // VectorStoreChatMemoryAdvisor.builder(ollamaRedisVectorStore).build(),
