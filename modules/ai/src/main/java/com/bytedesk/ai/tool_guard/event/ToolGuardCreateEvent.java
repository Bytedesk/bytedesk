...
/**
 * Event published when a new tool_guard is created.
 */
public class ToolGuardCreateEvent extends AbstractToolGuardEvent {

    private static final long serialVersionUID = 1L;

    public ToolGuardCreateEvent(ToolGuardEntity tool_guard) {
