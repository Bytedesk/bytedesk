 ...
 * @LastEditTime: 2025-02-22 09:19:21
...
public class SpringAiAlibabaConfig {
    ...
    ChatClient airlineTicketChatClient(ChatClient.Builder dashScopeChatClientBuilder, InMemoryChatMemory defaultChatMemory, VectorStore vectorStore) {
        return  dashScopeChatClientBuilder
        .defaultSystem("""
