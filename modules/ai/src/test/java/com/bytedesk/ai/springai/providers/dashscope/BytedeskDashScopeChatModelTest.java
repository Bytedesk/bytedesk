...
class BytedeskDashScopeChatModelTest {
    ...
    void mapsDashScopeUsageToSpringAiMetadataAndTokenUsageHelperKeys() throws Exception {
        ...
        BytedeskDashScopeChatModel model = new BytedeskDashScopeChatModel(
                "https://dashscope.aliyuncs.com",
                "test-api-key",
                BytedeskDashScopeChatOptions.builder().model("qwen-test").build());
    ...
    private static ChatResponse toChatResponse(BytedeskDashScopeChatModel model, GenerationResult result)
            throws Exception {
        Method method = BytedeskDashScopeChatModel.class.getDeclaredMethod("toChatResponse", GenerationResult.class);
