...
/**
 * Event published when a feedback_settings is deleted.
 */
public class FeedbackSettingsDeleteEvent extends AbstractFeedbackSettingsEvent {

    private static final long serialVersionUID = 1L;

    public FeedbackSettingsDeleteEvent(FeedbackSettingsEntity feedback_settings) {
