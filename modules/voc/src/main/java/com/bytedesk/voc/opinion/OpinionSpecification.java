...
@Slf4j
public class OpinionSpecification extends BaseSpecification<OpinionEntity, OpinionRequest> {
    
    public static Specification<OpinionEntity> search(OpinionRequest request, AuthService authService) {
