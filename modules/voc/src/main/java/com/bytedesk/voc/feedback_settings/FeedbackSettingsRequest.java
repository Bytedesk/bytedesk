...
@AllArgsConstructor
@NoArgsConstructor
public class FeedbackSettingsRequest extends BaseRequest {
    ...
    private Integer positiveScoreMin;

    private Integer scoreMax;

    private Integer maxReasons;
    ...
    // @Builder.Default
    // private String type = FeedbackSettingsTypeEnum.CUSTOMER.name();
