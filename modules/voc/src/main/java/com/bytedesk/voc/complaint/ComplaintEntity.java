...
/**
 * Complaint entity for content categorization and organization
 * Provides complaint functionality for various system entities
 * 
 * Database Table: bytedesk_core_complaint
 * Purpose: Stores complaint definitions, colors, and organization settings
 */
@Entity
@Data
@SuperBuilder
