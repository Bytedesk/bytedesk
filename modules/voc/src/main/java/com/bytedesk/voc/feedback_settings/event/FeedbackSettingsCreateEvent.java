...
/**
 * Event published when a new feedback_settings is created.
 */
public class FeedbackSettingsCreateEvent extends AbstractFeedbackSettingsEvent {

    private static final long serialVersionUID = 1L;

    public FeedbackSettingsCreateEvent(FeedbackSettingsEntity feedback_settings) {
