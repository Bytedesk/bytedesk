...
@Component
@AllArgsConstructor
public class VocCommentInitializer implements SmartInitializingSingleton {
    ...
    private void initAuthority() {
        for (PermissionEnum permission : PermissionEnum.values()) {
            String permissionValue = VocCommentPermissions.VOC_COMMENT_PREFIX + permission.name();
