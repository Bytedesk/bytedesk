...
public interface OpportunityRepository extends JpaRepository<OpportunityEntity, Long>, JpaSpecificationExecutor<OpportunityEntity> {
    ...
    Optional<OpportunityEntity> findByUid(String uid);

    Boolean existsByUid(String uid);

    Optional<OpportunityEntity> findByNameAndOrgUidAndTypeAndDeletedFalse(String name, String orgUid, String type);
