...
public class OpportunityRestController extends BaseRestController<OpportunityRequest, OpportunityRestService> {
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_QUERY_ORG, description = "query opportunity by org")
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_QUERY_USER, description = "query opportunity by user")
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_QUERY_DETAIL, description = "query opportunity by uid")
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_CREATE, description = "create opportunity")
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody OpportunityRequest request) {
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_UPDATE, description = "update opportunity")
    ...
    @PostMapping("/update")
    public ResponseEntity<?> update(@RequestBody OpportunityRequest request) {
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_DELETE, description = "delete opportunity")
    ...
    @PostMapping("/delete")
    public ResponseEntity<?> delete(@RequestBody OpportunityRequest request) {
    ...
    @ActionAnnotation(title = I18Consts.I18N_OPPORTUNITY, action = I18Consts.I18N_ACTION_EXPORT, description = "export opportunity")
