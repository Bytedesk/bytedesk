...
public class CustomerRestService extends BaseRestServiceWithExport<CustomerEntity, CustomerRequest, CustomerResponse, CustomerExcel> {
    ...
    public CustomerResponse create(CustomerRequest request) {
        ...
        if (!StringUtils.hasText(entity.getStatus())) {
            entity.setStatus(CustomerStatusEnum.NEW.getCode());
        }
        if (!StringUtils.hasText(entity.getSource())) {
            entity.setSource(CustomerSourceEnum.WEB.getCode());
        }
    ...
    public CustomerResponse update(CustomerRequest request) {
        ...
        if (entity.isPresent()) {
            ...
            updatedEntity.setCompanyName(request.getCompanyName());
            ...
            updatedEntity.setOwnerUserUid(request.getOwnerUserUid());
    ...
    public CustomerEntity handleOptimisticLockingFailureException(ObjectOptimisticLockingFailureException e, CustomerEntity entity) {
        try {
            ...
            if (latest.isPresent()) {
                ...
                latestEntity.setCompanyName(entity.getCompanyName());
