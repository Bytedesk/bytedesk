 ...
 * @LastEditTime: 2025-04-08 09:41:16
...
public class ThreadAgentsOfflineServiceDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        try {
            ...
            execution.setVariable(ThreadConsts.THREAD_VARIABLE_THREAD_STATUS, ThreadConsts.THREAD_STATUS_CLOSED);
