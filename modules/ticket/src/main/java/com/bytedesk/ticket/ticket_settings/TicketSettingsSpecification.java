...
@Slf4j
public class TicketSettingsSpecification extends BaseSpecification<TicketSettingsEntity, TicketSettingsRequest> {
    
    public static Specification<TicketSettingsEntity> search(TicketSettingsRequest request, AuthService authService) {
