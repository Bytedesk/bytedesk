...
import com.bytedesk.ticket.ticket_sla_rule.TicketSlaRuleRequest;
...
public class TicketSlaSettingsRequest extends BaseRequest {
    ...
    @Builder.Default
    private List<TicketSlaRuleRequest> rules = new ArrayList<>();
}