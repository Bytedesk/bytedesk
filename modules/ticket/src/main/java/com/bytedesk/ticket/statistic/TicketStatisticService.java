...
import com.bytedesk.ticket.utils.TicketStatisticConvertUtils;
...
public class TicketStatisticService {
    ...
    private TicketStatisticResponse calculateStatistics(
        ...
        if (shouldSave) {
            ...
            return TicketStatisticConvertUtils.convertToStatisticResponse(savedStatistic);
        }

        return TicketStatisticConvertUtils.convertToStatisticResponse(statistic);
    }
