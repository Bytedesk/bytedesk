 ...
 * @LastEditTime: 2025-08-24 16:14:59
...
public class TicketTemplateDeleteEvent extends ApplicationEvent {

    private static final long serialVersionUID = 1L;

    private TicketTemplateEntity ticketTemplate;

    public TicketTemplateDeleteEvent(TicketTemplateEntity ticketTemplate) {
