...
@NoArgsConstructor
@AllArgsConstructor
public class TicketCategorySettingsData implements Serializable {

    private static final long serialVersionUID = 1L;

    @Builder.Default
    private List<TicketCategoryItemData> items = new ArrayList<>();
    ...
    public void normalize() {
        ...
        // 填充默认值
        int index = 0;
        for (TicketCategoryItemData item : items) {
