...
@Slf4j
public class FormResultSpecification extends BaseSpecification<FormResultEntity, FormResultRequest> {
    
    public static Specification<FormResultEntity> search(FormResultRequest request, AuthService authService) {
