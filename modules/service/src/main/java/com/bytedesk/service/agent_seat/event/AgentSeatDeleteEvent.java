...
/**
 * Event published when a agent_seat is deleted.
 */
public class AgentSeatDeleteEvent extends AbstractAgentSeatEvent {

    private static final long serialVersionUID = 1L;

    public AgentSeatDeleteEvent(AgentSeatEntity agent_seat) {
