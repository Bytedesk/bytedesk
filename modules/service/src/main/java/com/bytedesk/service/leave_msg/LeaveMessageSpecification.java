 ...
 * @LastEditTime: 2024-07-02 18:17:47
...
@Slf4j
public class LeaveMessageSpecification extends BaseSpecification {
    
    public static Specification<LeaveMessage> search(LeaveMessageRequest request) {
