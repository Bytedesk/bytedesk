 ...
 * @LastEditTime: 2024-10-17 12:16:29
...
public class CounterController extends BaseRestController<CounterRequest> {
    ...
    @Override
    public ResponseEntity<?> create(CounterRequest request) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'create'");
    }

    @Override
    public ResponseEntity<?> update(CounterRequest request) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'update'");
    }

    @Override
    public ResponseEntity<?> delete(CounterRequest request) {
        // TODO Auto-generated method stub
