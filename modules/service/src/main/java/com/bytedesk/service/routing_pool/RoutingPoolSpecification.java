...
@Slf4j
public class RoutingPoolSpecification extends BaseSpecification<RoutingPoolEntity, RoutingPoolRequest> {
    
    public static Specification<RoutingPoolEntity> search(RoutingPoolRequest request, AuthService authService) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // 使用带层级过滤的基础条件
            predicates.addAll(getBasicPredicatesWithLevel(root, criteriaBuilder, request, authService, RoutingPoolPermissions.MODULE_NAME));
            // name
