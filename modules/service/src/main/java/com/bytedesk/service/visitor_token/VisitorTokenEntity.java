 ...
 * @LastEditTime: 2025-09-12 15:30:10
...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "bytedesk_service_visitor_token")
public class VisitorTokenEntity extends BaseEntity {
    ...
    private String type = VisitorTokenTypeEnum.BEARER.name();
