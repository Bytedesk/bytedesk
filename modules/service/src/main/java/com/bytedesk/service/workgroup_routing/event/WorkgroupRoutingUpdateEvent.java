 ...
 */
public class WorkgroupRoutingUpdateEvent extends AbstractWorkgroupRoutingEvent {

    private static final long serialVersionUID = 1L;

    public WorkgroupRoutingUpdateEvent(WorkgroupRoutingEntity workgroupRouting) {
