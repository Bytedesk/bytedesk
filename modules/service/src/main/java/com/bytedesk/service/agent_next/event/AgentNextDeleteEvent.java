...
/**
 * Event published when a agent_next is deleted.
 */
public class AgentNextDeleteEvent extends AbstractAgentNextEvent {

    private static final long serialVersionUID = 1L;

    public AgentNextDeleteEvent(AgentNextEntity agent_next) {
