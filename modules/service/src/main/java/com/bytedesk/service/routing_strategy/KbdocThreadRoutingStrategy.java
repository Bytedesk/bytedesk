 ...
 * @LastEditTime: 2025-04-19 10:00:17
 ...
 */
@Slf4j
@Component("kbdocThreadStrategy")
@AllArgsConstructor
public class KbdocThreadRoutingStrategy implements ThreadRoutingStrategy {
    ...
    public MessageProtobuf createThread(VisitorRequest visitorRequest) {
        return createKbdocThread(visitorRequest);
    }

    // 不支持转人工
    public MessageProtobuf createKbdocThread(VisitorRequest request) {
