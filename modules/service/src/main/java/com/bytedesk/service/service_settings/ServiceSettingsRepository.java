...
public interface ServiceSettingsRepository extends JpaRepository<ServiceSettingsEntity, Long>, JpaSpecificationExecutor<ServiceSettingsEntity> {

    Optional<ServiceSettingsEntity> findByUid(String uid);
