 ...
 * @LastEditTime: 2025-04-19 10:00:08
 ...
 */
@Slf4j
@Component("kbaseThreadStrategy")
@AllArgsConstructor
public class KbaseThreadRoutingStrategy implements ThreadRoutingStrategy {
    ...
    public MessageProtobuf createThread(VisitorRequest visitorRequest) {
        return createKbaseThread(visitorRequest);
    }

    // 不支持转人工
    public MessageProtobuf createKbaseThread(VisitorRequest request) {
