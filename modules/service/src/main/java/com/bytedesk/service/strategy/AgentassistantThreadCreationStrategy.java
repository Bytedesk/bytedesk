...
// // 客服助手会话
// @Component("agentassistantCsThreadStrategy")
// @AllArgsConstructor
// public class AgentassistantThreadCreationStrategy implements CsThreadCreationStrategy {
...
//         return createAgentassistantCsThread(visitorRequest);
//     }

//     public MessageProtobuf createAgentassistantCsThread(VisitorRequest visitorRequest) {
...
//         //
//         Thread thread = getAgentassistantThread(visitorRequest, robot);
//         //
//         return getAgentassistantMessage(visitorRequest, thread, robot);
//     }

//     private Thread getAgentassistantThread(VisitorRequest visitorRequest, Robot robot) {
//         if (robot == null) {
...
//         thread.setType(ThreadTypeEnum.AGENTASSISTANT.name());
...
//     private MessageProtobuf getAgentassistantMessage(VisitorRequest visitorRequest, Thread thread, Robot robot) {
//         if (thread == null) {
...
//         if (thread.getStatus() == ThreadStateEnum.START.name()) {
//             isReenter = false;
//         }
//         // 更新机器人配置+大模型相关信息
//         thread.setExtra(JSON.toJSONString(ConvertAiUtils.convertToServiceSettingsResponseVisitor(
...
//         } else {
//             thread.setStatus(isReenter ? ThreadStateEnum.CONTINUE.name() : ThreadStateEnum.START.name());
//         }
