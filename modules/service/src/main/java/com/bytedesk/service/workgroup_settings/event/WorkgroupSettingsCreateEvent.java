...
public class WorkgroupSettingsCreateEvent extends ApplicationEvent {

    private static final long serialVersionUID = 1L;

    private final WorkgroupSettingsEntity workgroupSettings;

    public WorkgroupSettingsCreateEvent(Object source, WorkgroupSettingsEntity workgroupSettings) {
        super(source);
