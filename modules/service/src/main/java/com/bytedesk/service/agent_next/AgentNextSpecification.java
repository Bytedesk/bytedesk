...
@Slf4j
public class AgentNextSpecification extends BaseSpecification<AgentNextEntity, AgentNextRequest> {

    // 模块名称，用于权限检查
    private static final String MODULE_NAME = "TAG";
    
    public static Specification<AgentNextEntity> search(AgentNextRequest request, AuthService authService) {
