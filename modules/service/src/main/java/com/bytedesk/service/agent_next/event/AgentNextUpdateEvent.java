...
/**
 * Event published when an existing agent_next is updated.
 */
public class AgentNextUpdateEvent extends AbstractAgentNextEvent {

    private static final long serialVersionUID = 1L;

    public AgentNextUpdateEvent(AgentNextEntity agent_next) {
