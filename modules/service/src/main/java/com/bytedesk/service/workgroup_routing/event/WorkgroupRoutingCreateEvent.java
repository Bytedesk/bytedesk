 ...
 */
public class WorkgroupRoutingCreateEvent extends AbstractWorkgroupRoutingEvent {

    private static final long serialVersionUID = 1L;

    public WorkgroupRoutingCreateEvent(WorkgroupRoutingEntity workgroupRouting) {
        super(workgroupRouting, workgroupRouting);
    }
}
