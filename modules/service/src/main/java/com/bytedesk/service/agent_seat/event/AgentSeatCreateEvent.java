...
/**
 * Event published when a new agent_seat is created.
 */
public class AgentSeatCreateEvent extends AbstractAgentSeatEvent {

    private static final long serialVersionUID = 1L;

    public AgentSeatCreateEvent(AgentSeatEntity agent_seat) {
