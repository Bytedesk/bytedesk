...
@Slf4j
public class PortalSpecification extends BaseSpecification<PortalEntity, PortalRequest> {
    
    public static Specification<PortalEntity> search(PortalRequest request, AuthService authService) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // 使用带层级过滤的基础条件
            predicates.addAll(getBasicPredicatesWithLevel(root, criteriaBuilder, request, authService, PortalPermissions.MODULE_NAME));
            // name
