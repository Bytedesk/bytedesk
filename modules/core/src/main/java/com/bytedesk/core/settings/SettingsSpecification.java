...
@Slf4j
public class SettingsSpecification extends BaseSpecification<SettingsEntity, SettingsRequest> {
    
    public static Specification<SettingsEntity> search(SettingsRequest request, AuthService authService) {
