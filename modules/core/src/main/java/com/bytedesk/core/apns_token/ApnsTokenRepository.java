...
public interface ApnsTokenRepository extends JpaRepository<ApnsTokenEntity, Long>, JpaSpecificationExecutor<ApnsTokenEntity> {

    Optional<ApnsTokenEntity> findByUid(String uid);

    Boolean existsByUid(String uid);

    Optional<ApnsTokenEntity> findByTokenAndDeletedFalse(String token);

    Optional<ApnsTokenEntity> findByTokenAndUserUidAndDeletedFalse(String token, String userUid);
