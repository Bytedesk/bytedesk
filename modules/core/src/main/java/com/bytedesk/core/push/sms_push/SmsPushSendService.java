...
public class SmsPushSendService {
    ...
    public SmsSendResult sendSmsWithResult(String mobile, String country, String content, HttpServletRequest request) {
        ...
        log.info("send sms_push to {}, country: {}, content: {}", normalizedMobile, country, content);
    ...
    public SmsSendResult sendValidateCode(String mobile, String country, String code) {
        ...
        String normalizedMobile = normalizeAndValidateMobile(mobile);
        log.info("sendValidateCode sms_push to {}, country: {}, code: {}", normalizedMobile, country, code);
        ...
        request.setSysDomain("dysms_pushapi.aliyuncs.com");
        request.setSysVersion("2017-05-25");
        request.setSysAction("SendSmsPush");
        ...
        try {
            ...
            log.info("sendValidateCode sms_push response: {}", response.getData());
