...
/**
 * Event published when a new email_template is created.
 */
public class EmailTemplateCreateEvent extends AbstractEmailTemplateEvent {

    private static final long serialVersionUID = 1L;

    public EmailTemplateCreateEvent(EmailTemplateEntity email_template) {
