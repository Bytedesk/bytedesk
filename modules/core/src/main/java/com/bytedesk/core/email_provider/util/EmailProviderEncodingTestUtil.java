 ...
 */
package com.bytedesk.core.email_provider.util;
 ...
 */
@Slf4j
public class EmailProviderEncodingTestUtil {
    ...
    public static void testMimeDecoding() {
        ...
        for (String testCase : testCases) {
            String decoded = EmailProviderEncodingUtil.decodeMimeString(testCase);
        ...
        for (String testCase : addressTestCases) {
            String email = EmailProviderEncodingUtil.extractEmailProviderFromString(testCase);
            String name = EmailProviderEncodingUtil.extractNameFromString(testCase);
    ...
    public static void verifyDecoding() {
        ...
        for (String testCase : testCases) {
            String autoDecoded = EmailProviderEncodingUtil.decodeMimeString(testCase);
