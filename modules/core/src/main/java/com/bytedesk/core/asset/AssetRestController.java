...
public class AssetRestController extends BaseRestController<AssetRequest, AssetRestService> {
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_QUERY_ORG, description = "query asset by org")
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_QUERY_USER, description = "query asset by user")
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_QUERY_DETAIL, description = "query asset by uid")
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_CREATE, description = "create asset")
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_UPDATE, description = "update asset")
    @Operation(summary = "Update Asset", description = "Update an existing asset")
    @Override
    @PreAuthorize(AssetPermissions.HAS_ASSET_UPDATE)
    @PostMapping("/update")
    public ResponseEntity<?> update(@RequestBody AssetRequest request) {
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_DELETE, description = "delete asset")
    @Operation(summary = "Delete Asset", description = "Delete a asset")
    @Override
    @PreAuthorize(AssetPermissions.HAS_ASSET_DELETE)
    @PostMapping("/delete")
    public ResponseEntity<?> delete(@RequestBody AssetRequest request) {
    ...
    @ActionAnnotation(title = I18Consts.I18N_ASSET, action = I18Consts.I18N_ACTION_EXPORT, description = "export asset")
