...
public class RoleCacheService {
    ...
    String defaultCacheKey = "roleList";
    ...
    // 模拟 push 操作：向列表中添加元素
    public void push(String roleJSON) {
        push(defaultCacheKey, roleJSON);
    }
