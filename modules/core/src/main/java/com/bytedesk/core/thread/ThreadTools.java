...
public class ThreadTools extends BaseTools<ThreadRequest, ThreadResponse> {
    ...
    @Tool(description = "Query thread by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Query thread by org with request json. This tool returns structured data for AI tool invocation.")
    public Object threadQueryByOrg(@ToolParam(description = "ThreadRequest json") String requestJson) {
        return doQueryByOrg(requestJson);
    }

    @Tool(description = "Query thread by user with request json. This tool returns structured data for AI tool invocation.")
    public Object threadQueryByUser(@ToolParam(description = "ThreadRequest json") String requestJson) {
        return doQueryByUser(requestJson);
    }

    @Tool(description = "Create thread with request json. This tool returns structured data for AI tool invocation.")
    public Object threadCreate(@ToolParam(description = "ThreadRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update thread with request json. This tool returns structured data for AI tool invocation.")
    public Object threadUpdate(@ToolParam(description = "ThreadRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete thread by uid. This tool returns structured data for AI tool invocation.")
