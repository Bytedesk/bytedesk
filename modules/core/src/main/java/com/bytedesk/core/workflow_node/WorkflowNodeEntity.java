...
@Table(name = "bytedesk_core_workflow_node", indexes = {
...
public class WorkflowNodeEntity extends BaseEntity {
    ...
    private WorkflowBaseNode parseNodeData(String jsonData, String nodeType) {
        ...
        switch (type) {
            case START:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowStartNode.class);
            case END:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowEndNode.class);
            case CONDITION:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowConditionNode.class);
            case LOOP:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowLoopNode.class);
            case LLM:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowLLMNode.class);
            case TEXT:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowTextNode.class);
            case COMMENT:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowCommentNode.class);
            case GROUP:
                return JSON.parseObject(jsonData, com.bytedesk.core.workflow.node.WorkflowGroupNode.class);
            default:
