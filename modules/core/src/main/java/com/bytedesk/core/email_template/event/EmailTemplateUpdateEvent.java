...
/**
 * Event published when an existing email_template is updated.
 */
public class EmailTemplateUpdateEvent extends AbstractEmailTemplateEvent {

    private static final long serialVersionUID = 1L;

    public EmailTemplateUpdateEvent(EmailTemplateEntity email_template) {
