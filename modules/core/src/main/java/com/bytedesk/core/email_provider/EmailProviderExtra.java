...
@NoArgsConstructor
@AllArgsConstructor
public class EmailProviderExtra extends BaseExtra {
     ...
     * @return EmailProviderExtra对象
     */
    public static EmailProviderExtra fromJson(String jsonString) {
        return JSON.parseObject(jsonString, EmailProviderExtra.class);
    }
} 