...
public class TaskTools extends BaseTools<TaskRequest, TaskResponse> {
    ...
    @Tool(description = "Query task by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Query task by org with request json. This tool returns structured data for AI tool invocation.")
    public Object taskQueryByOrg(@ToolParam(description = "TaskRequest json") String requestJson) {
        return doQueryByOrg(requestJson);
    }

    @Tool(description = "Query task by user with request json. This tool returns structured data for AI tool invocation.")
    public Object taskQueryByUser(@ToolParam(description = "TaskRequest json") String requestJson) {
        return doQueryByUser(requestJson);
    }

    @Tool(description = "Create task with request json. This tool returns structured data for AI tool invocation.")
    public Object taskCreate(@ToolParam(description = "TaskRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update task with request json. This tool returns structured data for AI tool invocation.")
    public Object taskUpdate(@ToolParam(description = "TaskRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete task by uid. This tool returns structured data for AI tool invocation.")
