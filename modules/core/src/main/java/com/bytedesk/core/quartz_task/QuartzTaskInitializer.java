...
@Component
@AllArgsConstructor
public class QuartzTaskInitializer implements SmartInitializingSingleton {
    ...
    private void initAuthority() {
        ...
        //     String permissionValue = QuartzTaskPermissions.QUARTZ_TASK_PREFIX + permission.name();
