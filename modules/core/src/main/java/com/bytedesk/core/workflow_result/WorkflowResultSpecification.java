...
@Slf4j
public class WorkflowResultSpecification extends BaseSpecification {
    
    public static Specification<WorkflowResultEntity> search(WorkflowResultRequest request) {
