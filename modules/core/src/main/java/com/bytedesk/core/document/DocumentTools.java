...
public class DocumentTools extends BaseTools<DocumentRequest, DocumentResponse> {
    ...
    @Tool(description = "Query document by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Query document by org with request json. This tool returns structured data for AI tool invocation.")
    public Object documentQueryByOrg(@ToolParam(description = "DocumentRequest json") String requestJson) {
        return doQueryByOrg(requestJson);
    }

    @Tool(description = "Query document by user with request json. This tool returns structured data for AI tool invocation.")
    public Object documentQueryByUser(@ToolParam(description = "DocumentRequest json") String requestJson) {
        return doQueryByUser(requestJson);
    }

    @Tool(description = "Create document with request json. This tool returns structured data for AI tool invocation.")
    public Object documentCreate(@ToolParam(description = "DocumentRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update document with request json. This tool returns structured data for AI tool invocation.")
    public Object documentUpdate(@ToolParam(description = "DocumentRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete document by uid. This tool returns structured data for AI tool invocation.")
