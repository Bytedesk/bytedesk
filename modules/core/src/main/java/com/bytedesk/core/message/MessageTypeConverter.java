...
public class MessageTypeConverter {
    ...
    static {
        ...
        typeToChineseMap.put(MessageTypeEnum.THREAD.name(), I18Consts.I18N_MESSAGE_TYPE_THREAD);
        ...
        typeToChineseMap.put(MessageTypeEnum.INVITE_AUDIO.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_AUDIO);
        typeToChineseMap.put(MessageTypeEnum.INVITE_VIDEO.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_VIDEO);
        typeToChineseMap.put(MessageTypeEnum.INVITE_AUDIO_REJECT.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_AUDIO_REJECT);
        typeToChineseMap.put(MessageTypeEnum.INVITE_VIDEO_REJECT.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_VIDEO_REJECT);
        typeToChineseMap.put(MessageTypeEnum.INVITE_AUDIO_ACCEPT.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_AUDIO_ACCEPT);
        typeToChineseMap.put(MessageTypeEnum.INVITE_VIDEO_ACCEPT.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_VIDEO_ACCEPT);
        typeToChineseMap.put(MessageTypeEnum.INVITE_AUDIO_CANCEL.name(), I18Consts.I18N_MESSAGE_TYPE_INVITE_AUDIO_CANCEL);
