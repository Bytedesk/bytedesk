...
@Slf4j
public class SmsPushSpecification extends BaseSpecification<SmsPushEntity, SmsPushRequest> {
    
    public static Specification<SmsPushEntity> search(SmsPushRequest request, AuthService authService) {
