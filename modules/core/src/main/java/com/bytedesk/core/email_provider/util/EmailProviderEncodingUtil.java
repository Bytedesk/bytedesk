 ...
 */
@Slf4j
public class EmailProviderEncodingUtil {
        ...
        try {
            if (message.getFrom() != null && message.getFrom().length > 0) {
                ...
                if (fromAddress instanceof InternetAddress) {
                    ...
                    return extractEmailProviderFromString(addressStr);
                }
            }
        } catch (Exception e) {
     ...
     * 从字符串中提取邮箱地址
     */
    public static String extractEmailProviderFromString(String addressStr) {
        if (addressStr == null) {
            return "";
        }
