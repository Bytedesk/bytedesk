 ...
 **/
@Slf4j
public class PhoneAnotherBinarySearchAlgorithmImpl implements PhoneLookupAlgorithm {
    ...
    public Optional<PhoneNumberInfo> lookup(String phoneNo) {
        ...
        Optional<PhoneISPEnum> isp = PhoneISPEnum.of(ispMark);
        ...
        PhoneAttribution build = PhoneAttribution.builder()
                ...
                .areaCode(split[3])
                .build();
        return Optional.of(new PhoneNumberInfo(phoneNo, build, isp.orElse(PhoneISPEnum.UNKNOWN)));
    }
