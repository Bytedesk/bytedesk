...
public class TopicSubscriptionTools extends BaseTools<TopicSubscriptionRequest, TopicSubscriptionResponse> {
    ...
    @Tool(description = "Query topicSubscription by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Create topicSubscription with request json. This tool returns structured data for AI tool invocation.")
    public Object topicSubscriptionCreate(@ToolParam(description = "TopicSubscriptionRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update topicSubscription with request json. This tool returns structured data for AI tool invocation.")
    public Object topicSubscriptionUpdate(@ToolParam(description = "TopicSubscriptionRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete topicSubscription by uid. This tool returns structured data for AI tool invocation.")
