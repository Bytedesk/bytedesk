...
public interface ApnsP12Repository extends JpaRepository<ApnsP12Entity, Long>, JpaSpecificationExecutor<ApnsP12Entity> {

    Optional<ApnsP12Entity> findByUid(String uid);
