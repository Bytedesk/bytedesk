...
/**
 * Event published when a new push_settings is created.
 */
public class PushSettingsCreateEvent extends AbstractPushSettingsEvent {

    private static final long serialVersionUID = 1L;

    public PushSettingsCreateEvent(PushSettingsEntity push_settings) {
