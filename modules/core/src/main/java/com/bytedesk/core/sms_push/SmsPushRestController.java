...
public class SmsPushRestController extends BaseRestController<SmsPushRequest, SmsPushRestService> {
    ...
    @Override
    @PreAuthorize(SmsPushPermissions.HAS_SMS_PUSH_READ)
    ...
    @Override
    @PreAuthorize(SmsPushPermissions.HAS_SMS_PUSH_CREATE)
    @PostMapping("/create")
    ...
    @Override
    @PreAuthorize(SmsPushPermissions.HAS_SMS_PUSH_UPDATE)
    @PostMapping("/update")
    ...
    @Override
    @PreAuthorize(SmsPushPermissions.HAS_SMS_PUSH_DELETE)
    @PostMapping("/delete")
    ...
    @Override
    @PreAuthorize(SmsPushPermissions.HAS_SMS_PUSH_EXPORT)
    @GetMapping("/export")
