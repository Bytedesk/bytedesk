...
public abstract class AbstractNotificationEvent extends ApplicationEvent {
    ...
    protected AbstractNotificationEvent(Object source, NotificationEntity notification) {
        super(source);
    ...
    private NotificationEntity snapshot(NotificationEntity source) {
        if (source == null) {
            return null;
        }
        try {
            ...
            throw new IllegalStateException("Failed to snapshot notification " + source.getUid(), ex);
        }
    }
}
