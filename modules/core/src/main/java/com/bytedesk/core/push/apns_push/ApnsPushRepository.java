...
public interface ApnsPushRepository extends JpaRepository<ApnsPushEntity, Long>, JpaSpecificationExecutor<ApnsPushEntity> {

    Optional<ApnsPushEntity> findByUid(String uid);
