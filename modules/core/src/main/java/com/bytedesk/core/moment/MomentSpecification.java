 ...
 * @LastEditTime: 2025-08-01 23:33:25
...
@Slf4j
public class MomentSpecification extends BaseSpecification<MomentEntity, MomentRequest> {
    
    public static Specification<MomentEntity> search(MomentRequest request, AuthService authService) {
