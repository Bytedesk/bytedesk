...
/**
 * Event published when a push_settings is deleted.
 */
public class PushSettingsDeleteEvent extends AbstractPushSettingsEvent {

    private static final long serialVersionUID = 1L;

    public PushSettingsDeleteEvent(PushSettingsEntity push_settings) {
