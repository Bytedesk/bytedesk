...
public class QuartzTaskUpdateEvent extends AbstractQuartzTaskEvent {

    private static final long serialVersionUID = 1L;

    public QuartzTaskUpdateEvent(QuartzTaskEntity quartz_task) {
        super(quartz_task, quartz_task);
    }
