...
/**
 * Event published when a new topic_subscription is created.
 */
public class TopicSubscriptionCreateEvent extends AbstractTopicSubscriptionEvent {

    private static final long serialVersionUID = 1L;

    public TopicSubscriptionCreateEvent(TopicSubscriptionEntity topic_subscription) {
