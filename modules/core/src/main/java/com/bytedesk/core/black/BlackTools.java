...
public class BlackTools extends BaseTools<BlackRequest, BlackResponse> {
    ...
    @Tool(description = "Query black by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Query black by org with request json. This tool returns structured data for AI tool invocation.")
    public Object blackQueryByOrg(@ToolParam(description = "BlackRequest json") String requestJson) {
        return doQueryByOrg(requestJson);
    }

    @Tool(description = "Query black by user with request json. This tool returns structured data for AI tool invocation.")
    public Object blackQueryByUser(@ToolParam(description = "BlackRequest json") String requestJson) {
        return doQueryByUser(requestJson);
    }

    @Tool(description = "Create black with request json. This tool returns structured data for AI tool invocation.")
    public Object blackCreate(@ToolParam(description = "BlackRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update black with request json. This tool returns structured data for AI tool invocation.")
    public Object blackUpdate(@ToolParam(description = "BlackRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete black by uid. This tool returns structured data for AI tool invocation.")
