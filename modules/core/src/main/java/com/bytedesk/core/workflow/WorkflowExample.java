...
public class WorkflowExample {
    ...
    public static WorkflowDocument createExampleWorkflow() {
        ...
        WorkflowLLMNode llmNode = WorkflowLLMNode.builder()
                ...
                .type("llm")
                .name("LLM_0")
                .meta("{\"position\":{\"x\":1660.1942854301792,\"y\":1.8635936030104148}}")
