...
@Slf4j
public class TaskListSpecification extends BaseSpecification<TaskListEntity, TaskListRequest> {
    
    public static Specification<TaskListEntity> search(TaskListRequest request, AuthService authService) {
