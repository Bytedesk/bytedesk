...
public class TaskListTools extends BaseTools<TaskListRequest, TaskListResponse> {
    ...
    @Tool(description = "Query taskList by uid. This tool returns structured data for AI tool invocation.")
    ...
    @Tool(description = "Query taskList by org with request json. This tool returns structured data for AI tool invocation.")
    public Object taskListQueryByOrg(@ToolParam(description = "TaskListRequest json") String requestJson) {
        return doQueryByOrg(requestJson);
    }

    @Tool(description = "Query taskList by user with request json. This tool returns structured data for AI tool invocation.")
    public Object taskListQueryByUser(@ToolParam(description = "TaskListRequest json") String requestJson) {
        return doQueryByUser(requestJson);
    }

    @Tool(description = "Create taskList with request json. This tool returns structured data for AI tool invocation.")
    public Object taskListCreate(@ToolParam(description = "TaskListRequest json") String requestJson) {
        return doCreate(requestJson);
    }

    @Tool(description = "Update taskList with request json. This tool returns structured data for AI tool invocation.")
    public Object taskListUpdate(@ToolParam(description = "TaskListRequest json") String requestJson) {
        return doUpdate(requestJson);
    }

    @Tool(description = "Delete taskList by uid. This tool returns structured data for AI tool invocation.")
