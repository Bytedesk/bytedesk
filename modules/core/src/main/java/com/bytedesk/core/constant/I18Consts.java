...
public class I18Consts {
    ...
    public static final String I18N_MESSAGE_TYPE_THREAD = "会话消息"; // 会话消息
    ...
    public static final String I18N_MESSAGE_TYPE_INVITE_AUDIO = "音频通话邀请"; // 音频通话邀请
    public static final String I18N_MESSAGE_TYPE_INVITE_VIDEO = "视频通话邀请"; // 视频通话邀请
    public static final String I18N_MESSAGE_TYPE_INVITE_AUDIO_REJECT = "音频通话拒绝"; // 音频通话拒绝
    public static final String I18N_MESSAGE_TYPE_INVITE_VIDEO_REJECT = "视频通话拒绝"; // 视频通话拒绝
    public static final String I18N_MESSAGE_TYPE_INVITE_AUDIO_ACCEPT = "音频通话接受"; // 音频通话接受
    public static final String I18N_MESSAGE_TYPE_INVITE_VIDEO_ACCEPT = "视频通话接受"; // 视频通话接受
    public static final String I18N_MESSAGE_TYPE_INVITE_AUDIO_CANCEL = "音频通话取消"; // 音频通话取消
    public static final String I18N_MESSAGE_TYPE_INVITE_VIDEO_CANCEL = "视频通话取消"; // 视频通话取消
    public static final String I18N_MESSAGE_TYPE_INVITE_AUDIO_TIMEOUT = "音频通话超时"; // 音频通话超时
    public static final String I18N_MESSAGE_TYPE_INVITE_VIDEO_TIMEOUT = "视频通话超时"; // 视频通话超时
