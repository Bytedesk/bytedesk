...
public class I18Consts {
    ...
    // 模块常量：原 @ActionAnnotation 硬编码 title 迁移（前端 locales i18n.ts 同名 key 翻译）
    public static final String I18N_ACD = I18N_PREFIX + "acd";
    public static final String I18N_ACD_AGENT_STATE = I18N_PREFIX + "acd.agent.state";
    public static final String I18N_ACD_QUEUE_ENTRY = I18N_PREFIX + "acd.queue.entry";
    public static final String I18N_AGENT_CANNED_RESPONSE = I18N_PREFIX + "agent.canned.response";
    public static final String I18N_AGENT_GUIDELINE = I18N_PREFIX + "agent.guideline";
    public static final String I18N_AGENT_GUIDELINE_BINDING = I18N_PREFIX + "agent.guideline.binding";
    public static final String I18N_AGENT_SCHEDULE = I18N_PREFIX + "agent.schedule";
    public static final String I18N_AGENT_TURN_TRACE = I18N_PREFIX + "agent.turn.trace";
    public static final String I18N_BOOKING = I18N_PREFIX + "booking";
    public static final String I18N_BRIDGE = I18N_PREFIX + "bridge";
    public static final String I18N_CDR = I18N_PREFIX + "cdr";
    public static final String I18N_CALL_BLOCK = I18N_PREFIX + "call.block";
    public static final String I18N_CALL_BROADCAST = I18N_PREFIX + "call.broadcast";
    public static final String I18N_CALL_CUSTOMER = I18N_PREFIX + "call.customer";
    public static final String I18N_CALL_CUSTOMER_LIST = I18N_PREFIX + "call.customer.list";
    public static final String I18N_CALL_FLOW = I18N_PREFIX + "call.flow";
    public static final String I18N_CALL_LEAVEMSG = I18N_PREFIX + "call.leavemsg";
    public static final String I18N_CALL_POPUP = I18N_PREFIX + "call.popup";
    public static final String I18N_CALL_QUEUE = I18N_PREFIX + "call.queue";
    public static final String I18N_CALL_QUEUE_AGENT = I18N_PREFIX + "call.queue.agent";
    public static final String I18N_CALL_QUEUE_MEMBER = I18N_PREFIX + "call.queue.member";
    public static final String I18N_CALL_RATING = I18N_PREFIX + "call.rating";
    public static final String I18N_CALL_RECORDING = I18N_PREFIX + "call.recording";
    public static final String I18N_CALL_TASK = I18N_PREFIX + "call.task";
    public static final String I18N_CALL_ROUTE = I18N_PREFIX + "call.route";
    public static final String I18N_CARRIER_LINE = I18N_PREFIX + "carrier.line";
    public static final String I18N_CONFERENCE_ROOM = I18N_PREFIX + "conference.room";
    public static final String I18N_CONFERENCE_SETTINGS = I18N_PREFIX + "conference.settings";
    public static final String I18N_CONSUMER = I18N_PREFIX + "consumer";
    public static final String I18N_CTI = I18N_PREFIX + "cti";
    public static final String I18N_DESTINATION = I18N_PREFIX + "destination";
    public static final String I18N_DIALPLAN = I18N_PREFIX + "dialplan";
    public static final String I18N_DOMAIN = I18N_PREFIX + "domain";
    public static final String I18N_EXTENSION = I18N_PREFIX + "extension";
    public static final String I18N_EXTENSION_SETTINGS = I18N_PREFIX + "extension.settings";
    public static final String I18N_FEISHU = I18N_PREFIX + "feishu";
    public static final String I18N_GATEWAY = I18N_PREFIX + "gateway";
    public static final String I18N_GOODS = I18N_PREFIX + "goods";
    public static final String I18N_INTENTION = I18N_PREFIX + "intention";
    public static final String I18N_IVR_MENU = I18N_PREFIX + "ivr.menu";
    public static final String I18N_IVR_RECORD = I18N_PREFIX + "ivr.record";
    public static final String I18N_KAKAO = I18N_PREFIX + "kakao";
    public static final String I18N_LINE = I18N_PREFIX + "line";
    public static final String I18N_MCP_CLIENT = I18N_PREFIX + "mcp.client";
    public static final String I18N_MOH = I18N_PREFIX + "moh";
    public static final String I18N_PHRASE = I18N_PREFIX + "phrase";
    public static final String I18N_PROMPT = I18N_PREFIX + "prompt";
    public static final String I18N_QUALITY_APPEAL = I18N_PREFIX + "quality.appeal";
    public static final String I18N_QUALITY_CHECK = I18N_PREFIX + "quality.check";
    public static final String I18N_QUALITY_FLOW = I18N_PREFIX + "quality.flow";
    public static final String I18N_QUALITY_INSPECTION_TASK = I18N_PREFIX + "quality.inspection.task";
    public static final String I18N_QUALITY_PLAN = I18N_PREFIX + "quality.plan";
    public static final String I18N_QUALITY_RULE = I18N_PREFIX + "quality.rule";
    public static final String I18N_QUALITY_STATISTIC = I18N_PREFIX + "quality.statistic";
    public static final String I18N_RECOMMENDATION = I18N_PREFIX + "recommendation";
    public static final String I18N_RECORDINGS = I18N_PREFIX + "recordings";
    public static final String I18N_REGISTRATION = I18N_PREFIX + "registration";
    public static final String I18N_RING_GROUP = I18N_PREFIX + "ring.group";
    public static final String I18N_SHOP = I18N_PREFIX + "shop";
    public static final String I18N_SIP_PROFILE = I18N_PREFIX + "sip.profile";
    public static final String I18N_SLACK = I18N_PREFIX + "slack";
    public static final String I18N_SMS_PROVIDER = I18N_PREFIX + "sms.provider";
    public static final String I18N_SMS_TEMPLATE = I18N_PREFIX + "sms.template";
    public static final String I18N_STREAM = I18N_PREFIX + "stream";
    public static final String I18N_SUBSCRIPTION = I18N_PREFIX + "subscription";
    public static final String I18N_TELEGRAM = I18N_PREFIX + "telegram";
    public static final String I18N_THREAD_STATUS = I18N_PREFIX + "thread.status";
    public static final String I18N_TIKTOK = I18N_PREFIX + "tiktok";
    public static final String I18N_TRUNK = I18N_PREFIX + "trunk";
    public static final String I18N_UNIFIED_SETTINGS = I18N_PREFIX + "unified.settings";
    public static final String I18N_UNIFIED = I18N_PREFIX + "unified";
    public static final String I18N_VISITOR_WEBRTC = I18N_PREFIX + "visitor.webrtc";
    public static final String I18N_VOICEMAIL = I18N_PREFIX + "voicemail";
    public static final String I18N_WEBHOOK = I18N_PREFIX + "webhook";
    public static final String I18N_WEBHOOK_MESSAGE = I18N_PREFIX + "webhook.message";
    public static final String I18N_WEBRTC = I18N_PREFIX + "webrtc";
    public static final String I18N_WHATSAPP = I18N_PREFIX + "whatsapp";
    public static final String I18N_ZALO = I18N_PREFIX + "zalo";
    public static final String I18N_MRCP = I18N_PREFIX + "mrcp";
    public static final String I18N_TABOO_MESSAGE = I18N_PREFIX + "taboo.message";
    ...
    public static final String I18N_MOBILE_NOT_BOUND = I18N_PREFIX + "mobile.not.bound"; // 手机号与当前账号绑定不一致
    public static final String I18N_EMAIL_NOT_BOUND = I18N_PREFIX + "email.not.bound"; // 邮箱与当前账号绑定不一致
