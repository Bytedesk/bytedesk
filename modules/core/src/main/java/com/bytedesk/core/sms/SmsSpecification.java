...
@Slf4j
public class SmsSpecification extends BaseSpecification<SmsEntity, SmsRequest> {
    
    public static Specification<SmsEntity> search(SmsRequest request, AuthService authService) {
