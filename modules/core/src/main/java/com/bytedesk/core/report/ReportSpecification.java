...
public class ReportSpecification extends BaseSpecification<ReportEntity, ReportRequest> {
    ...
    public static Specification<ReportEntity> search(ReportRequest request, AuthService authService) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // 使用带层级过滤的基础条件
            predicates.addAll(getBasicPredicatesWithLevel(root, criteriaBuilder, request, authService, ReportPermissions.MODULE_NAME));
            // name
