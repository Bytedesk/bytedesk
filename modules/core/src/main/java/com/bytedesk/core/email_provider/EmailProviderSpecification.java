...
@Slf4j
public class EmailProviderSpecification extends BaseSpecification<EmailProviderEntity, EmailProviderRequest> {
    
    public static Specification<EmailProviderEntity> search(EmailProviderRequest request, AuthService authService) {
