      ...
      <div class="row align-items-center">
        <div class="col-md-8">
          <div class="brand">
            ...
            <h2><i class="fas fa-folder me-2"></i>${(category.name)!category.uid}</h2>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <aside class="sidebar">
          <div class="panel">
            <h3><i class="fas fa-folder me-2"></i>全部分类</h3>
            <#if categories?? && (categories?size > 0)>
              <div>
                <#list categories as c>
                  <a href="/blog/${kbase.uid!''}/category/${c.uid}.html"
                     class="category-chip<#if (category.uid?? && category.uid == c.uid)> active</#if>">
      ...
      <div class="col-lg-9">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">${(category.name)!category.uid}</li>
          </ol>
        </nav>

        <div class="panel">
          <h3><i class="fas fa-file-alt me-2"></i>文章列表</h3>
