...
@Slf4j
public class TextSpecification extends BaseSpecification<TextEntity, TextRequest> {
    
    public static Specification<TextEntity> search(TextRequest request, AuthService authService) {
