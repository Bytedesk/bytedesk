 ...
 * @LastEditTime: 2024-08-01 11:36:15
...
public class AutoReplyExcelListener implements ReadListener<AutoReplyExcel> {
    ...
    public void invoke(AutoReplyExcel data, AnalysisContext context) {
        ...
        AutoReply autoReply = autoreplyService.convertExcelToAutoReply(data, categoryUid, kbUid, orgUid);
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        log.info("AutoReplyExcelListener doAfterAllAnalysed");
