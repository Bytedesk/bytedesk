...
public class TextExcelListener implements ReadListener<TextExcel> {
     ...
     * 缓存的数据
     */
    private List<TextEntity> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        log.info("TextExcelListener doAfterAllAnalysed");
