...
@Slf4j
public class WebsiteSpecification extends BaseSpecification<WebsiteEntity, WebsiteRequest> {
    
    public static Specification<WebsiteEntity> search(WebsiteRequest request, AuthService authService) {
