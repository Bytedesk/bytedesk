...
public interface ImageRepository extends JpaRepository<ImageEntity, Long>, JpaSpecificationExecutor<ImageEntity> {
    ...
    Optional<ImageEntity> findByDocId(String docId);

    List<ImageEntity> findByKbase_UidAndDeletedFalse(String kbUid);
    
    List<ImageEntity> findByFile_UidAndDeletedFalse(String fileUid);
}
