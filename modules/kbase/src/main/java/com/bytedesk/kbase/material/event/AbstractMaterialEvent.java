 ...
 */
public abstract class AbstractMaterialEvent extends ApplicationEvent {

    private static final long serialVersionUID = 1L;

    private final MaterialEntity material;

    protected AbstractMaterialEvent(Object source, MaterialEntity material) {
        super(source);
    ...
    private MaterialEntity snapshot(MaterialEntity source) {
        if (source == null) {
            return null;
        }
        try {
            ...
            throw new IllegalStateException("Failed to snapshot material " + source.getUid(), ex);
        }
    }
}
