...
@Slf4j
public class ImageSpecification extends BaseSpecification<ImageEntity, ImageRequest> {
    
    public static Specification<ImageEntity> search(ImageRequest request, AuthService authService) {
