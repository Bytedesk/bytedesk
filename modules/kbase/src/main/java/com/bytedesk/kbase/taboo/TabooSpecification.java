 ...
 * @LastEditTime: 2025-03-10 15:55:11
...
@Slf4j
public class TabooSpecification extends BaseSpecification<TabooEntity, TabooRequest> {
    
    public static Specification<TabooEntity> search(TabooRequest request, AuthService authService) {
