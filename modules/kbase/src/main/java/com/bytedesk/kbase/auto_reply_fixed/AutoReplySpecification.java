 ...
 * @LastEditTime: 2024-12-05 09:36:45
...
@Slf4j
public class AutoReplySpecification extends BaseSpecification {
    
    public static Specification<AutoReplyEntity> search(AutoReplyRequest request) {
