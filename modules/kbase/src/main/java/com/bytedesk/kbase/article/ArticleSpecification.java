...
@Slf4j
public class ArticleSpecification extends BaseSpecification<ArticleEntity, ArticleRequest> {

    public static Specification<ArticleEntity> search(ArticleRequest request, AuthService authService) {
