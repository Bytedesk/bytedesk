...
@AllArgsConstructor
public class AutoReplyRestController extends BaseRestController<AutoReplyRequest> {
    ...
    public ResponseEntity<?> queryByUser(AutoReplyRequest request) {
        ...
        Page<AutoReplyResponse> page = autoReplyService.queryByUser(request);
    ...
    public Object export(AutoReplyRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            // download filename
            String fileName = "AutoReply-" + BdDateUtils.formatDatetimeUid() + ".xlsx";
