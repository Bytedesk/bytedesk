...
@Component
@AllArgsConstructor
public class TabooVipEventListener {
    ...
    private void processMessage(String messageJson) {
        ...
        // log.info("taboo processMessage {}", messageProtobuf.getContent());
        //
        ...
        //     if (splits.length < 4) {
        //         throw new RuntimeException("taboo appointed topic format error");
        //     }
        //     String agentUid = splits[2];
        //     String visitorUid = splits[3];
        //     log.info("taboo agentUid {}, visitorUid {}", agentUid, visitorUid);
        //     if (senderUid.equals(visitorUid)) {
        //         filterTaboo(agentUid, visitorUid, thread);
        //     }
        // } else if (TopicUtils.isOrgWorkgroupTopic(threadTopic)) {
        //     // 技能组客服 topic格式：org/workgroup/{workgroup_uid}/{agent_uid}/{visitor_uid}
        //     String[] splits = threadTopic.split("/");
        //     if (splits.length < 5) {
        //         throw new RuntimeException("taboo workgroup topic format error");
        //     }
        //     String workgroupUid = splits[2];
        //     String agentUid = splits[3];
        //     String visitorUid = splits[4];
        //     log.info("taboo workgroupUid {}, agentUid {}, visitorUid {}", workgroupUid, agentUid, visitorUid);
        //     if (senderUid.equals(visitorUid)) {
        //         filterTaboo(agentUid, visitorUid, thread);
        //     }
        // }
    ...
    // private void filterTaboo(String agentUid, String visitorUid, ThreadProtobuf thread) {
