...
class WebpageSpecificationTest {

    @Test
    void searchShouldFilterByCategoryUidCollection() {
        WebpageRequest request = WebpageRequest.builder()
                .superUser(true)
        ...
        Root<WebpageEntity> root = mock(Root.class);
        @SuppressWarnings("unchecked")
        CriteriaQuery<WebpageEntity> query = mock(CriteriaQuery.class);
        ...
        Specification<WebpageEntity> specification = WebpageSpecification.search(request, authService);
