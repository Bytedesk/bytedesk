...
/**
 * Event published when a webrtc_settings is deleted.
 */
public class WebrtcSettingsDeleteEvent extends AbstractWebrtcSettingsEvent {

    private static final long serialVersionUID = 1L;

    public WebrtcSettingsDeleteEvent(WebrtcSettingsEntity webrtc_settings) {
