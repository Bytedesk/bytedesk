...
/**
 * Event published when an existing webrtc_settings is updated.
 */
public class WebrtcSettingsUpdateEvent extends AbstractWebrtcSettingsEvent {

    private static final long serialVersionUID = 1L;

    public WebrtcSettingsUpdateEvent(WebrtcSettingsEntity webrtc_settings) {
