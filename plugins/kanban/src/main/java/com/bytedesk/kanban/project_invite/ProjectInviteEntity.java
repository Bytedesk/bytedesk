 ...
 * @LastEditTime: 2025-03-15 10:28:36
...
@AllArgsConstructor
@NoArgsConstructor
@EntityListeners({ProjectInviteEntityListener.class})
@Table(name = "bytedesk_kanban_project_invite")
public class ProjectInviteEntity extends BaseEntity {
