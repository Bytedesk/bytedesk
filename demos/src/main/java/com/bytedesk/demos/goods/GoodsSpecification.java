...
@Slf4j
public class GoodsSpecification extends BaseSpecification<GoodsEntity, GoodsRequest> {
    
    public static Specification<GoodsEntity> search(GoodsRequest request, AuthService authService) {
