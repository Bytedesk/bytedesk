        ...
        if (type >= MQTTConnect &&
            ...
            if (offset > 0 &&
                ...
                if ((type == MQTTPublish && (qos >= MQTTQosLevelAtMostOnce && qos <= MQTTQosLevelExactlyOnce)) ||
                    ...
                    if (type == MQTTPuback ||
                        ...
                        if (protocolLevel != MQTTProtocolVersion50) {
                            ...
                            if (message.data.length < 3) {
                                NSLog(@"[MQTTMessage] no returncode");
                                message = nil;
                            } else {
                    ...
                    if (type == MQTTConnect) {
                        if (message.data.length < 3) {
                            NSLog(@"[MQTTMessage] missing connect variable header");
                            message = nil;
                        }
                    }
                    if (type == MQTTConnack) {
                        if (protocolLevel == MQTTProtocolVersion50) {
                            if (message.data.length < 3) {
                                NSLog(@"[MQTTMessage] missing connack variable header");
                                message = nil;
                            }
                        } else {
                            if (message.data.length != 2) {
                    ...
                    if (type == MQTTSubscribe) {
                        if (message.data.length < 3) {
                            NSLog(@"[MQTTMessage] missing subscribe variable header");
                            message = nil;
                        }
                    }
                    if (type == MQTTSuback) {
                        if (message.data.length < 3) {
                            NSLog(@"[MQTTMessage] missing suback variable header");
                            message = nil;
                        }
                    }
                    if (type == MQTTUnsubscribe) {
                        if (message.data.length < 3) {
                            NSLog(@"[MQTTMessage] missing unsubscribe variable header");
                            message = nil;
                        }
                    }
                } else {
