...
describe("<QuickReply />", () => {
  ...
  it("should render the icon", () => {
    ...
    expect(quickReply?.querySelector("use")).toHaveAttribute(
      "xlink:href",
      "#icon-foo",
    );
  });
  ...
  it("should render the image", () => {
    ...
    expect(quickReply?.querySelector(".QuickReply-img")).toHaveAttribute(
      "src",
      img,
    );
  });
  ...
  it("should have a highlight style", () => {
    const { container } = render(
      <QuickReply
        item={{ name: "testName", isHighlight: true }}
        index={0}
        onClick={() => {}}
      />,
    );
