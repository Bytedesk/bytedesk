...
describe("<Base />", () => {
  ...
  it("should have a title", () => {
    const { baseElement } = render(
      <Base active baseClass="test" title="test" titleId="testId" />,
    );
  ...
  it("should render actions", () => {
    const { baseElement } = render(
      <Base active baseClass="test" actions={[{ label: "test1" }]} />,
    );

    expect(baseElement.querySelectorAll(".Btn").length).toBe(1);
    expect(baseElement.querySelector(".test-footer")).toHaveClass(
      "test-footer--v",
    );
  });
  ...
  it("should have a custom className", () => {
    const { baseElement } = render(
      <Base baseClass="test" className="custom" active />,
    );
