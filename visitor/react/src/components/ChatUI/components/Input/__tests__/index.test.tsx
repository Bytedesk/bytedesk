...
describe("<Input />", () => {
  ...
  it("should render a textarea via multiline", () => {
    const { getByTestId } = render(
      <Input value="" multiline data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should render a textarea via autoSize", () => {
    const { getByTestId } = render(
      <Input value="" autoSize data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should render a textarea via rows", () => {
    const { getByTestId } = render(
      <Input value="" rows={2} data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should have a custom type", () => {
    const { getByTestId } = render(
      <Input value="" type="number" data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should have the rows (> minRows)", () => {
    const { getByTestId } = render(
      <Input value="" rows={2} minRows={3} data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should have the rows (< maxRows)", () => {
    const { getByTestId } = render(
      <Input value="" rows={4} maxRows={3} data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should be disabled", () => {
    const { getByTestId } = render(
      <Input disabled value="" data-testid="input" />,
    );
    const inputElement = getByTestId("input");
  ...
  it("should call onChange callback", (done) => {
    const { getByTestId } = render(
      <Input value="" onChange={() => done()} data-testid="input" />,
    );
    const inputElement = getByTestId("input");
