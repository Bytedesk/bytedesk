...
describe("<Goods />", () => {
  it("should render the name", () => {
    const { getByTestId } = render(
      <Goods name="testName" data-testid="goods" />,
    );
  ...
  it("should render the image", () => {
    ...
    const { getByTestId } = render(
      <Goods name="testName" img={img} data-testid="goods" />,
    );
    const goods = getByTestId("goods");
  ...
  it("should render the description", () => {
    const { getByTestId } = render(
      <Goods name="testName" desc="testDesc" data-testid="goods" />,
    );
    const goods = getByTestId("goods");
  ...
  it("should render the price", () => {
    const { getByTestId } = render(
      <Goods name="testName" price={123} data-testid="goods" />,
    );
    const goods = getByTestId("goods");
  ...
  it("should render the meta content", () => {
    const { getByTestId } = render(
      <Goods name="testName" meta="testMeta" data-testid="goods" />,
    );
    const goods = getByTestId("goods");
  ...
  it("should render order", () => {
    ...
    expect(order.querySelector(".Goods-detailBtn")).toHaveTextContent(
      "testAction",
    );
  });
});
